...
export default class ProjectGenerator extends Generator {
    ...
    configuring() {
        ...
        if (report.violations.length > 0) {
            throw new Error(`Budget violations found. Generation aborted. Fix the violations or relax your budget policy in application.json.`);
        }
    }
    /**
     * @author arefin
     ...
     */
    _writeManaged(templatePath, outputPath, ctx) {
        const fullPath = this.destinationPath(outputPath);
