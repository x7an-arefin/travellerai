 ...
 */
export function hashSpecification(specPath) {
 ...
 */
export function buildManifest(specPath, entries) {
    return {
 ...
 */
export function generatedFileHeader(entityName, operation) {
    return [
        '// ╔══════════════════════════════════════════════════════════════════════╗',
 ...
 */
export function scaffoldedFileHeader() {
    return [
        '// ╔══════════════════════════════════════════════════════════════════════╗',
