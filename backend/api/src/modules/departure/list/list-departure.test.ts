...
import { pre } from './list-departure.pre.js';
import { process } from './list-departure.process.js';
import { post } from './list-departure.post.js';
...
describe('Departure — LIST lifecycle unit tests', () => {
...
describe('Departure — LIST controller integration tests', () => {
   ...
   */
  it('GET /departures responds with expected status', async () => {
