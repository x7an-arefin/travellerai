...
import { DepartureController } from '@modules/departure/departure.controller.js';
import { DepartureService } from '@modules/departure/departure.service.js';
import { DepartureRepository } from '@modules/departure/departure.repository.js';
import { pre } from './update-departure.pre.js';
import { process } from './update-departure.process.js';
import { post } from './update-departure.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/departures'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('Departure — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a Departure in the database', async () => {
...
describe('Departure — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /departures/:id responds with expected status', async () => {
    const res = await testApp.request('/departures/:id', {
      method: 'PATCH',
