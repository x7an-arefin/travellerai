...
import { pre } from './delete-departure.pre.js';
import { process } from './delete-departure.process.js';
import { post } from './delete-departure.post.js';
...
describe('Departure — DELETE lifecycle unit tests', () => {
...
describe('Departure — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /departures/:id responds with expected status', async () => {
