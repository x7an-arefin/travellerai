...
import { pre } from './create-departure.pre.js';
import { process } from './create-departure.process.js';
import { post } from './create-departure.post.js';
...
describe('Departure — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a Departure in the database', async () => {
...
describe('Departure — CREATE controller integration tests', () => {
   ...
   */
  it('POST /departures responds with expected status', async () => {
    const res = await testApp.request('/departures', {
      method: 'POST',
