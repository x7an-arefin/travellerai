...
import { pre } from './get-departure.pre.js';
import { process } from './get-departure.process.js';
import { post } from './get-departure.post.js';
...
describe('Departure — GET lifecycle unit tests', () => {
...
describe('Departure — GET controller integration tests', () => {
   ...
   */
  it('GET /departures/:id responds with expected status', async () => {
