...
import { pre } from './list-destination.pre.js';
import { process } from './list-destination.process.js';
import { post } from './list-destination.post.js';
...
describe('Destination — LIST lifecycle unit tests', () => {
...
describe('Destination — LIST controller integration tests', () => {
   ...
   */
  it('GET /destinations responds with expected status', async () => {
