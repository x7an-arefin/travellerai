...
import { pre } from './create-destination.pre.js';
import { process } from './create-destination.process.js';
import { post } from './create-destination.post.js';
...
describe('Destination — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a Destination in the database', async () => {
...
describe('Destination — CREATE controller integration tests', () => {
   ...
   */
  it('POST /destinations responds with expected status', async () => {
    const res = await testApp.request('/destinations', {
      method: 'POST',
