...
import { pre } from './get-destination.pre.js';
import { process } from './get-destination.process.js';
import { post } from './get-destination.post.js';
...
describe('Destination — GET lifecycle unit tests', () => {
...
describe('Destination — GET controller integration tests', () => {
   ...
   */
  it('GET /destinations/:id responds with expected status', async () => {
