...
import { pre } from './create-hotel-booking.pre.js';
import { process } from './create-hotel-booking.process.js';
import { post } from './create-hotel-booking.post.js';
...
describe('HotelBooking — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a HotelBooking in the database', async () => {
...
describe('HotelBooking — CREATE controller integration tests', () => {
   ...
   */
  it('POST /hotel-bookings responds with expected status', async () => {
    const res = await testApp.request('/hotel-bookings', {
      method: 'POST',
