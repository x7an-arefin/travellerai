...
import { pre } from './list-hotel-booking.pre.js';
import { process } from './list-hotel-booking.process.js';
import { post } from './list-hotel-booking.post.js';
...
describe('HotelBooking — LIST lifecycle unit tests', () => {
...
describe('HotelBooking — LIST controller integration tests', () => {
   ...
   */
  it('GET /hotel-bookings responds with expected status', async () => {
