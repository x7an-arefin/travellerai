...
import { pre } from './delete-hotel-booking.pre.js';
import { process } from './delete-hotel-booking.process.js';
import { post } from './delete-hotel-booking.post.js';
...
describe('HotelBooking — DELETE lifecycle unit tests', () => {
...
describe('HotelBooking — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /hotel-bookings/:id responds with expected status', async () => {
