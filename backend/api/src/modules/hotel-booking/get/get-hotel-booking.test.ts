...
import { pre } from './get-hotel-booking.pre.js';
import { process } from './get-hotel-booking.process.js';
import { post } from './get-hotel-booking.post.js';
...
describe('HotelBooking — GET lifecycle unit tests', () => {
...
describe('HotelBooking — GET controller integration tests', () => {
   ...
   */
  it('GET /hotel-bookings/:id responds with expected status', async () => {
