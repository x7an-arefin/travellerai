...
import { HotelBookingController } from '@modules/hotel-booking/hotel-booking.controller.js';
import { HotelBookingService } from '@modules/hotel-booking/hotel-booking.service.js';
import { HotelBookingRepository } from '@modules/hotel-booking/hotel-booking.repository.js';
import { pre } from './update-hotel-booking.pre.js';
import { process } from './update-hotel-booking.process.js';
import { post } from './update-hotel-booking.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/hotel-bookings'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('HotelBooking — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a HotelBooking in the database', async () => {
...
describe('HotelBooking — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /hotel-bookings/:id responds with expected status', async () => {
    const res = await testApp.request('/hotel-bookings/:id', {
      method: 'PATCH',
