...
import { pre } from './update-driver.pre.js';
import { process } from './update-driver.process.js';
import { post } from './update-driver.post.js';
...
describe('Driver — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a Driver in the database', async () => {
...
describe('Driver — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /drivers/:id responds with expected status', async () => {
    const res = await testApp.request('/drivers/:id', {
      method: 'PATCH',
