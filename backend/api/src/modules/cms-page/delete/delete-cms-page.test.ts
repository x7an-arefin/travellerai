...
import { pre } from './delete-cms-page.pre.js';
import { process } from './delete-cms-page.process.js';
import { post } from './delete-cms-page.post.js';
...
describe('CmsPage — DELETE lifecycle unit tests', () => {
...
describe('CmsPage — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /cms-pages/:id responds with expected status', async () => {
