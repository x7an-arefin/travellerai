...
import { pre } from './list-cms-page.pre.js';
import { process } from './list-cms-page.process.js';
import { post } from './list-cms-page.post.js';
...
describe('CmsPage — LIST lifecycle unit tests', () => {
...
describe('CmsPage — LIST controller integration tests', () => {
   ...
   */
  it('GET /cms-pages responds with expected status', async () => {
