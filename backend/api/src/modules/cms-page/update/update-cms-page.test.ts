...
import { CmsPageController } from '@modules/cms-page/cms-page.controller.js';
import { CmsPageService } from '@modules/cms-page/cms-page.service.js';
import { CmsPageRepository } from '@modules/cms-page/cms-page.repository.js';
import { pre } from './update-cms-page.pre.js';
import { process } from './update-cms-page.process.js';
import { post } from './update-cms-page.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/cms-pages'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('CmsPage — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a CmsPage in the database', async () => {
...
describe('CmsPage — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /cms-pages/:id responds with expected status', async () => {
    const res = await testApp.request('/cms-pages/:id', {
      method: 'PATCH',
