...
import { pre } from './update-provider.pre.js';
import { process } from './update-provider.process.js';
import { post } from './update-provider.post.js';
...
describe('Provider — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a Provider in the database', async () => {
...
describe('Provider — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /providers/:id responds with expected status', async () => {
