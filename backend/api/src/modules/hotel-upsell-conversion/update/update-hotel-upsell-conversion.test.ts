...
import { pre } from './update-hotel-upsell-conversion.pre.js';
import { process } from './update-hotel-upsell-conversion.process.js';
import { post } from './update-hotel-upsell-conversion.post.js';
...
describe('HotelUpsellConversion — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a HotelUpsellConversion in the database', async () => {
...
describe('HotelUpsellConversion — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /hotel-upsell-conversions/:id responds with expected status', async () => {
