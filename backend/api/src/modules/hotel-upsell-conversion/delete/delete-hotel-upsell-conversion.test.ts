...
import { pre } from './delete-hotel-upsell-conversion.pre.js';
import { process } from './delete-hotel-upsell-conversion.process.js';
import { post } from './delete-hotel-upsell-conversion.post.js';
...
describe('HotelUpsellConversion — DELETE lifecycle unit tests', () => {
...
describe('HotelUpsellConversion — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /hotel-upsell-conversions/:id responds with expected status', async () => {
