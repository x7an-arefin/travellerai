...
import { pre } from './create-hotel-upsell-conversion.pre.js';
import { process } from './create-hotel-upsell-conversion.process.js';
import { post } from './create-hotel-upsell-conversion.post.js';
...
describe('HotelUpsellConversion — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a HotelUpsellConversion in the database', async () => {
...
describe('HotelUpsellConversion — CREATE controller integration tests', () => {
   ...
   */
  it('POST /hotel-upsell-conversions responds with expected status', async () => {
    const res = await testApp.request('/hotel-upsell-conversions', {
      method: 'POST',
