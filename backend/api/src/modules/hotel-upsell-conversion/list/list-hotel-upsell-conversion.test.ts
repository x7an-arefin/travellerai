...
import { pre } from './list-hotel-upsell-conversion.pre.js';
import { process } from './list-hotel-upsell-conversion.process.js';
import { post } from './list-hotel-upsell-conversion.post.js';
...
describe('HotelUpsellConversion — LIST lifecycle unit tests', () => {
...
describe('HotelUpsellConversion — LIST controller integration tests', () => {
   ...
   */
  it('GET /hotel-upsell-conversions responds with expected status', async () => {
