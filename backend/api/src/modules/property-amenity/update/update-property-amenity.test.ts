...
import { pre } from './update-property-amenity.pre.js';
import { process } from './update-property-amenity.process.js';
import { post } from './update-property-amenity.post.js';
...
describe('PropertyAmenity — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a PropertyAmenity in the database', async () => {
...
describe('PropertyAmenity — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /property-amenities/:id responds with expected status', async () => {
