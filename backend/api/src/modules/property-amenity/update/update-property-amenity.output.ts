...
export const UpdatePropertyAmenityOutputSchema = PropertyAmenityBaseSchema;


export type UpdatePropertyAmenityOutput = z.infer<typeof UpdatePropertyAmenityOutputSchema>;
