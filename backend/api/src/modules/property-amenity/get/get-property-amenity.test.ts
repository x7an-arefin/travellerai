...
import { pre } from './get-property-amenity.pre.js';
import { process } from './get-property-amenity.process.js';
import { post } from './get-property-amenity.post.js';
...
describe('PropertyAmenity — GET lifecycle unit tests', () => {
...
describe('PropertyAmenity — GET controller integration tests', () => {
   ...
   */
  it('GET /property-amenities/:id responds with expected status', async () => {
