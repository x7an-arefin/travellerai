...
export const GetPropertyAmenityOutputSchema = PropertyAmenityBaseSchema;


export type GetPropertyAmenityOutput = z.infer<typeof GetPropertyAmenityOutputSchema>;
