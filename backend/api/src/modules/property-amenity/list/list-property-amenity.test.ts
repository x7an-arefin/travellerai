...
import { pre } from './list-property-amenity.pre.js';
import { process } from './list-property-amenity.process.js';
import { post } from './list-property-amenity.post.js';
...
describe('PropertyAmenity — LIST lifecycle unit tests', () => {
...
describe('PropertyAmenity — LIST controller integration tests', () => {
   ...
   */
  it('GET /property-amenities responds with expected status', async () => {
