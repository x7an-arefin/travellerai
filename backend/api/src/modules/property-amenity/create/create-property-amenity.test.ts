...
import { pre } from './create-property-amenity.pre.js';
import { process } from './create-property-amenity.process.js';
import { post } from './create-property-amenity.post.js';
...
describe('PropertyAmenity — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a PropertyAmenity in the database', async () => {
...
describe('PropertyAmenity — CREATE controller integration tests', () => {
   ...
   */
  it('POST /property-amenities responds with expected status', async () => {
    const res = await testApp.request('/property-amenities', {
      method: 'POST',
