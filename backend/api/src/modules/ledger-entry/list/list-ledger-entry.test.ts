...
import { pre } from './list-ledger-entry.pre.js';
import { process } from './list-ledger-entry.process.js';
import { post } from './list-ledger-entry.post.js';
...
describe('LedgerEntry — LIST lifecycle unit tests', () => {
...
describe('LedgerEntry — LIST controller integration tests', () => {
   ...
   */
  it('GET /ledger-entries responds with expected status', async () => {
