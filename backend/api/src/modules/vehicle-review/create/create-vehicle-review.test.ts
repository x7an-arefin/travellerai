...
import { pre } from './create-vehicle-review.pre.js';
import { process } from './create-vehicle-review.process.js';
import { post } from './create-vehicle-review.post.js';
...
describe('VehicleReview — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehicleReview in the database', async () => {
...
describe('VehicleReview — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-reviews responds with expected status', async () => {
    const res = await testApp.request('/vehicle-reviews', {
      method: 'POST',
