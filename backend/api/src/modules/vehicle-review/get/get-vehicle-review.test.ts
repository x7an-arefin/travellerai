...
import { pre } from './get-vehicle-review.pre.js';
import { process } from './get-vehicle-review.process.js';
import { post } from './get-vehicle-review.post.js';
...
describe('VehicleReview — GET lifecycle unit tests', () => {
...
describe('VehicleReview — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicle-reviews/:id responds with expected status', async () => {
