...
import { pre } from './delete-vehicle-review.pre.js';
import { process } from './delete-vehicle-review.process.js';
import { post } from './delete-vehicle-review.post.js';
...
describe('VehicleReview — DELETE lifecycle unit tests', () => {
...
describe('VehicleReview — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-reviews/:id responds with expected status', async () => {
