...
import { VehicleReviewController } from '@modules/vehicle-review/vehicle-review.controller.js';
import { VehicleReviewService } from '@modules/vehicle-review/vehicle-review.service.js';
import { VehicleReviewRepository } from '@modules/vehicle-review/vehicle-review.repository.js';
import { pre } from './update-vehicle-review.pre.js';
import { process } from './update-vehicle-review.process.js';
import { post } from './update-vehicle-review.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/vehicle-reviews'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('VehicleReview — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a VehicleReview in the database', async () => {
...
describe('VehicleReview — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /vehicle-reviews/:id responds with expected status', async () => {
    const res = await testApp.request('/vehicle-reviews/:id', {
      method: 'PATCH',
