...
import { pre } from './list-vehicle-review.pre.js';
import { process } from './list-vehicle-review.process.js';
import { post } from './list-vehicle-review.post.js';
...
describe('VehicleReview — LIST lifecycle unit tests', () => {
...
describe('VehicleReview — LIST controller integration tests', () => {
   ...
   */
  it('GET /vehicle-reviews responds with expected status', async () => {
