...
import { pre } from './delete-user.pre.js';
import { process } from './delete-user.process.js';
import { post } from './delete-user.post.js';
...
describe('User — DELETE lifecycle unit tests', () => {
...
describe('User — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /users/:id responds with expected status', async () => {
