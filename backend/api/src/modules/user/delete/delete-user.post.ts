...
/**
 * @author arefin
 * @description POST lifecycle handler for DELETE User — publishes domain events and performs post-operation side effects after the core logic succeeds
 */
