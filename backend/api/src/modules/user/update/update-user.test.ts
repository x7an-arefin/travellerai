...
import { pre } from './update-user.pre.js';
import { process } from './update-user.process.js';
import { post } from './update-user.post.js';
...
describe('User — UPDATE lifecycle unit tests', () => {
...
describe('User — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /users/:id responds with expected status', async () => {
