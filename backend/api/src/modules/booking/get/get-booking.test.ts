...
import { pre } from './get-booking.pre.js';
import { process } from './get-booking.process.js';
import { post } from './get-booking.post.js';
...
describe('Booking — GET lifecycle unit tests', () => {
...
describe('Booking — GET controller integration tests', () => {
   ...
   */
  it('GET /bookings/:id responds with expected status', async () => {
