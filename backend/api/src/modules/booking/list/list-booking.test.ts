...
import { pre } from './list-booking.pre.js';
import { process } from './list-booking.process.js';
import { post } from './list-booking.post.js';
...
describe('Booking — LIST lifecycle unit tests', () => {
...
describe('Booking — LIST controller integration tests', () => {
   ...
   */
  it('GET /bookings responds with expected status', async () => {
