...
import { pre } from './create-booking.pre.js';
import { process } from './create-booking.process.js';
import { post } from './create-booking.post.js';
...
describe('Booking — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a Booking in the database', async () => {
...
describe('Booking — CREATE controller integration tests', () => {
   ...
   */
  it('POST /bookings responds with expected status', async () => {
    const res = await testApp.request('/bookings', {
      method: 'POST',
