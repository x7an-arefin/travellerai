...
import { pre } from './delete-booking.pre.js';
import { process } from './delete-booking.process.js';
import { post } from './delete-booking.post.js';
...
describe('Booking — DELETE lifecycle unit tests', () => {
...
describe('Booking — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /bookings/:id responds with expected status', async () => {
