...
export const CreateVehicleMaintenanceLogOutputSchema = VehicleMaintenanceLogBaseSchema;


export type CreateVehicleMaintenanceLogOutput = z.infer<typeof CreateVehicleMaintenanceLogOutputSchema>;
