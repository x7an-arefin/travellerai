...
import { pre } from './create-vehicle-maintenance-log.pre.js';
import { process } from './create-vehicle-maintenance-log.process.js';
import { post } from './create-vehicle-maintenance-log.post.js';
...
describe('VehicleMaintenanceLog — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehicleMaintenanceLog in the database', async () => {
...
describe('VehicleMaintenanceLog — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-maintenance-logs responds with expected status', async () => {
    const res = await testApp.request('/vehicle-maintenance-logs', {
      method: 'POST',
