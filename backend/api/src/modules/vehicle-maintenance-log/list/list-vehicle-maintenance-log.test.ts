...
import { pre } from './list-vehicle-maintenance-log.pre.js';
import { process } from './list-vehicle-maintenance-log.process.js';
import { post } from './list-vehicle-maintenance-log.post.js';
...
describe('VehicleMaintenanceLog — LIST lifecycle unit tests', () => {
...
describe('VehicleMaintenanceLog — LIST controller integration tests', () => {
   ...
   */
  it('GET /vehicle-maintenance-logs responds with expected status', async () => {
