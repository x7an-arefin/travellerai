...
import { pre } from './delete-vehicle-maintenance-log.pre.js';
import { process } from './delete-vehicle-maintenance-log.process.js';
import { post } from './delete-vehicle-maintenance-log.post.js';
...
describe('VehicleMaintenanceLog — DELETE lifecycle unit tests', () => {
...
describe('VehicleMaintenanceLog — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-maintenance-logs/:id responds with expected status', async () => {
