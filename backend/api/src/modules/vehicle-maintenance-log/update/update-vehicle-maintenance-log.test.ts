...
import { pre } from './update-vehicle-maintenance-log.pre.js';
import { process } from './update-vehicle-maintenance-log.process.js';
import { post } from './update-vehicle-maintenance-log.post.js';
...
describe('VehicleMaintenanceLog — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a VehicleMaintenanceLog in the database', async () => {
...
describe('VehicleMaintenanceLog — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /vehicle-maintenance-logs/:id responds with expected status', async () => {
