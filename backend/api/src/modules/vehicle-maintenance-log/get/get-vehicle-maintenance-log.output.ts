...
export const GetVehicleMaintenanceLogOutputSchema = VehicleMaintenanceLogBaseSchema;


export type GetVehicleMaintenanceLogOutput = z.infer<typeof GetVehicleMaintenanceLogOutputSchema>;
