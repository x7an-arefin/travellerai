...
import { pre } from './update-kyc-document.pre.js';
import { process } from './update-kyc-document.process.js';
import { post } from './update-kyc-document.post.js';
...
describe('KycDocument — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a KycDocument in the database', async () => {
...
describe('KycDocument — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /kyc-documents/:id responds with expected status', async () => {
    const res = await testApp.request('/kyc-documents/:id', {
      method: 'PATCH',
