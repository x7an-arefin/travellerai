...
import { pre } from './create-kyc-document.pre.js';
import { process } from './create-kyc-document.process.js';
import { post } from './create-kyc-document.post.js';
...
describe('KycDocument — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a KycDocument in the database', async () => {
...
describe('KycDocument — CREATE controller integration tests', () => {
   ...
   */
  it('POST /kyc-documents responds with expected status', async () => {
