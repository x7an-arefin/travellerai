...
import { pre } from './delete-kyc-document.pre.js';
import { process } from './delete-kyc-document.process.js';
import { post } from './delete-kyc-document.post.js';
...
describe('KycDocument — DELETE lifecycle unit tests', () => {
...
describe('KycDocument — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /kyc-documents/:id responds with expected status', async () => {
