...
import { pre } from './get-kyc-document.pre.js';
import { process } from './get-kyc-document.process.js';
import { post } from './get-kyc-document.post.js';
...
describe('KycDocument — GET lifecycle unit tests', () => {
...
describe('KycDocument — GET controller integration tests', () => {
   ...
   */
  it('GET /kyc-documents/:id responds with expected status', async () => {
