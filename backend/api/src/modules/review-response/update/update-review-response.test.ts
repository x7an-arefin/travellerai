...
import { ReviewResponseController } from '@modules/review-response/review-response.controller.js';
import { ReviewResponseService } from '@modules/review-response/review-response.service.js';
import { ReviewResponseRepository } from '@modules/review-response/review-response.repository.js';
import { pre } from './update-review-response.pre.js';
import { process } from './update-review-response.process.js';
import { post } from './update-review-response.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/review-responses'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('ReviewResponse — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a ReviewResponse in the database', async () => {
...
describe('ReviewResponse — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /review-responses/:id responds with expected status', async () => {
    const res = await testApp.request('/review-responses/:id', {
      method: 'PATCH',
