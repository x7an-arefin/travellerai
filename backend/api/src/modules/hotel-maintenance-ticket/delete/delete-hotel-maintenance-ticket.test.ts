...
import { pre } from './delete-hotel-maintenance-ticket.pre.js';
import { process } from './delete-hotel-maintenance-ticket.process.js';
import { post } from './delete-hotel-maintenance-ticket.post.js';
...
describe('HotelMaintenanceTicket — DELETE lifecycle unit tests', () => {
...
describe('HotelMaintenanceTicket — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /hotel-maintenance-tickets/:id responds with expected status', async () => {
