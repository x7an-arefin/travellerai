...
import { pre } from './list-hotel-maintenance-ticket.pre.js';
import { process } from './list-hotel-maintenance-ticket.process.js';
import { post } from './list-hotel-maintenance-ticket.post.js';
...
describe('HotelMaintenanceTicket — LIST lifecycle unit tests', () => {
...
describe('HotelMaintenanceTicket — LIST controller integration tests', () => {
   ...
   */
  it('GET /hotel-maintenance-tickets responds with expected status', async () => {
