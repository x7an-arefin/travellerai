...
import { pre } from './get-hotel-maintenance-ticket.pre.js';
import { process } from './get-hotel-maintenance-ticket.process.js';
import { post } from './get-hotel-maintenance-ticket.post.js';
...
describe('HotelMaintenanceTicket — GET lifecycle unit tests', () => {
...
describe('HotelMaintenanceTicket — GET controller integration tests', () => {
   ...
   */
  it('GET /hotel-maintenance-tickets/:id responds with expected status', async () => {
