...
import { pre } from './create-hotel-maintenance-ticket.pre.js';
import { process } from './create-hotel-maintenance-ticket.process.js';
import { post } from './create-hotel-maintenance-ticket.post.js';
...
describe('HotelMaintenanceTicket — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a HotelMaintenanceTicket in the database', async () => {
...
describe('HotelMaintenanceTicket — CREATE controller integration tests', () => {
   ...
   */
  it('POST /hotel-maintenance-tickets responds with expected status', async () => {
    const res = await testApp.request('/hotel-maintenance-tickets', {
      method: 'POST',
