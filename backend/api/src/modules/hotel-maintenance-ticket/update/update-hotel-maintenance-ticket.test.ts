...
import { HotelMaintenanceTicketController } from '@modules/hotel-maintenance-ticket/hotel-maintenance-ticket.controller.js';
import { HotelMaintenanceTicketService } from '@modules/hotel-maintenance-ticket/hotel-maintenance-ticket.service.js';
import { HotelMaintenanceTicketRepository } from '@modules/hotel-maintenance-ticket/hotel-maintenance-ticket.repository.js';
import { pre } from './update-hotel-maintenance-ticket.pre.js';
import { process } from './update-hotel-maintenance-ticket.process.js';
import { post } from './update-hotel-maintenance-ticket.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/hotel-maintenance-tickets'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('HotelMaintenanceTicket — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a HotelMaintenanceTicket in the database', async () => {
...
describe('HotelMaintenanceTicket — UPDATE controller integration tests', () => {
  ...
  beforeEach(async () => {
    testApp = await createControllerTestApplication({
      controller: HotelMaintenanceTicketController,
   ...
   */
  it('PATCH /hotel-maintenance-tickets/:id responds with expected status', async () => {
    const res = await testApp.request('/hotel-maintenance-tickets/:id', {
      method: 'PATCH',
