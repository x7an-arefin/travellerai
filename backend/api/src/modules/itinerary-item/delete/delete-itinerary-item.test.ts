...
import { pre } from './delete-itinerary-item.pre.js';
import { process } from './delete-itinerary-item.process.js';
import { post } from './delete-itinerary-item.post.js';
...
describe('ItineraryItem — DELETE lifecycle unit tests', () => {
...
describe('ItineraryItem — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /itinerary-items/:id responds with expected status', async () => {
