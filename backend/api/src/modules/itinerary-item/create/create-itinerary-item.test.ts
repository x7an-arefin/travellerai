...
import { pre } from './create-itinerary-item.pre.js';
import { process } from './create-itinerary-item.process.js';
import { post } from './create-itinerary-item.post.js';
...
describe('ItineraryItem — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a ItineraryItem in the database', async () => {
...
describe('ItineraryItem — CREATE controller integration tests', () => {
   ...
   */
  it('POST /itinerary-items responds with expected status', async () => {
    const res = await testApp.request('/itinerary-items', {
      method: 'POST',
