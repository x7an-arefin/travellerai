...
import { pre } from './list-itinerary-item.pre.js';
import { process } from './list-itinerary-item.process.js';
import { post } from './list-itinerary-item.post.js';
...
describe('ItineraryItem — LIST lifecycle unit tests', () => {
...
describe('ItineraryItem — LIST controller integration tests', () => {
   ...
   */
  it('GET /itinerary-items responds with expected status', async () => {
