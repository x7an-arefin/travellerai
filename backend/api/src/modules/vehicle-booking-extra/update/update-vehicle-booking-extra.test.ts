...
import { VehicleBookingExtraController } from '@modules/vehicle-booking-extra/vehicle-booking-extra.controller.js';
import { VehicleBookingExtraService } from '@modules/vehicle-booking-extra/vehicle-booking-extra.service.js';
import { VehicleBookingExtraRepository } from '@modules/vehicle-booking-extra/vehicle-booking-extra.repository.js';
import { pre } from './update-vehicle-booking-extra.pre.js';
import { process } from './update-vehicle-booking-extra.process.js';
import { post } from './update-vehicle-booking-extra.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/vehicle-booking-extras'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('VehicleBookingExtra — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a VehicleBookingExtra in the database', async () => {
...
describe('VehicleBookingExtra — UPDATE controller integration tests', () => {
  ...
  beforeEach(async () => {
    testApp = await createControllerTestApplication({
      controller: VehicleBookingExtraController,
   ...
   */
  it('PATCH /vehicle-booking-extras/:id responds with expected status', async () => {
    const res = await testApp.request('/vehicle-booking-extras/:id', {
      method: 'PATCH',
