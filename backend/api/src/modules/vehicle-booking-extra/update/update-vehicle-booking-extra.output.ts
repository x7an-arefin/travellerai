...
export const UpdateVehicleBookingExtraOutputSchema = VehicleBookingExtraBaseSchema;


export type UpdateVehicleBookingExtraOutput = z.infer<typeof UpdateVehicleBookingExtraOutputSchema>;
