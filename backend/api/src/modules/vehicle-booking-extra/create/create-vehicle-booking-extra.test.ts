...
import { pre } from './create-vehicle-booking-extra.pre.js';
import { process } from './create-vehicle-booking-extra.process.js';
import { post } from './create-vehicle-booking-extra.post.js';
...
describe('VehicleBookingExtra — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehicleBookingExtra in the database', async () => {
...
describe('VehicleBookingExtra — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-booking-extras responds with expected status', async () => {
    const res = await testApp.request('/vehicle-booking-extras', {
      method: 'POST',
