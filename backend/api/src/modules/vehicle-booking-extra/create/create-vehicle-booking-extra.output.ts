...
export const CreateVehicleBookingExtraOutputSchema = VehicleBookingExtraBaseSchema;


export type CreateVehicleBookingExtraOutput = z.infer<typeof CreateVehicleBookingExtraOutputSchema>;
