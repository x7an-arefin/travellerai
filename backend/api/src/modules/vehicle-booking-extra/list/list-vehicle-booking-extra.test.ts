...
import { pre } from './list-vehicle-booking-extra.pre.js';
import { process } from './list-vehicle-booking-extra.process.js';
import { post } from './list-vehicle-booking-extra.post.js';
...
describe('VehicleBookingExtra — LIST lifecycle unit tests', () => {
...
describe('VehicleBookingExtra — LIST controller integration tests', () => {
   ...
   */
  it('GET /vehicle-booking-extras responds with expected status', async () => {
