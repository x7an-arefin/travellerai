...
import { pre } from './delete-vehicle-booking-extra.pre.js';
import { process } from './delete-vehicle-booking-extra.process.js';
import { post } from './delete-vehicle-booking-extra.post.js';
...
describe('VehicleBookingExtra — DELETE lifecycle unit tests', () => {
...
describe('VehicleBookingExtra — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-booking-extras/:id responds with expected status', async () => {
