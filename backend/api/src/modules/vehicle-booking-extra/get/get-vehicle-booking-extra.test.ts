...
import { pre } from './get-vehicle-booking-extra.pre.js';
import { process } from './get-vehicle-booking-extra.process.js';
import { post } from './get-vehicle-booking-extra.post.js';
...
describe('VehicleBookingExtra — GET lifecycle unit tests', () => {
...
describe('VehicleBookingExtra — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicle-booking-extras/:id responds with expected status', async () => {
