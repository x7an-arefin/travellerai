...
import { pre } from './create-guide-profile.pre.js';
import { process } from './create-guide-profile.process.js';
import { post } from './create-guide-profile.post.js';
...
describe('GuideProfile — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a GuideProfile in the database', async () => {
...
describe('GuideProfile — CREATE controller integration tests', () => {
   ...
   */
  it('POST /guide-profiles responds with expected status', async () => {
    const res = await testApp.request('/guide-profiles', {
      method: 'POST',
