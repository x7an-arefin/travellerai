...
import { pre } from './list-guide-profile.pre.js';
import { process } from './list-guide-profile.process.js';
import { post } from './list-guide-profile.post.js';
...
describe('GuideProfile — LIST lifecycle unit tests', () => {
...
describe('GuideProfile — LIST controller integration tests', () => {
   ...
   */
  it('GET /guide-profiles responds with expected status', async () => {
