...
import { pre } from './get-guide-profile.pre.js';
import { process } from './get-guide-profile.process.js';
import { post } from './get-guide-profile.post.js';
...
describe('GuideProfile — GET lifecycle unit tests', () => {
...
describe('GuideProfile — GET controller integration tests', () => {
   ...
   */
  it('GET /guide-profiles/:id responds with expected status', async () => {
