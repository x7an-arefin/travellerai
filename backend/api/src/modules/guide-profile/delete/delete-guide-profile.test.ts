...
import { pre } from './delete-guide-profile.pre.js';
import { process } from './delete-guide-profile.process.js';
import { post } from './delete-guide-profile.post.js';
...
describe('GuideProfile — DELETE lifecycle unit tests', () => {
...
describe('GuideProfile — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /guide-profiles/:id responds with expected status', async () => {
