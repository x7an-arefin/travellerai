...
import { pre } from './list-vehicle-inspection.pre.js';
import { process } from './list-vehicle-inspection.process.js';
import { post } from './list-vehicle-inspection.post.js';
...
describe('VehicleInspection — LIST lifecycle unit tests', () => {
...
describe('VehicleInspection — LIST controller integration tests', () => {
   ...
   */
  it('GET /vehicle-inspections responds with expected status', async () => {
