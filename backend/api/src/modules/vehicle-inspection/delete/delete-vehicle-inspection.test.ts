...
import { pre } from './delete-vehicle-inspection.pre.js';
import { process } from './delete-vehicle-inspection.process.js';
import { post } from './delete-vehicle-inspection.post.js';
...
describe('VehicleInspection — DELETE lifecycle unit tests', () => {
...
describe('VehicleInspection — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-inspections/:id responds with expected status', async () => {
