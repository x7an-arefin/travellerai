...
import { pre } from './create-vehicle-inspection.pre.js';
import { process } from './create-vehicle-inspection.process.js';
import { post } from './create-vehicle-inspection.post.js';
...
describe('VehicleInspection — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehicleInspection in the database', async () => {
...
describe('VehicleInspection — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-inspections responds with expected status', async () => {
    const res = await testApp.request('/vehicle-inspections', {
      method: 'POST',
