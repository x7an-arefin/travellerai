...
export const CreateVehicleInspectionOutputSchema = VehicleInspectionBaseSchema;


export type CreateVehicleInspectionOutput = z.infer<typeof CreateVehicleInspectionOutputSchema>;
