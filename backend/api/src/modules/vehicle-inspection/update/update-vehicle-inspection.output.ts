...
export const UpdateVehicleInspectionOutputSchema = VehicleInspectionBaseSchema;


export type UpdateVehicleInspectionOutput = z.infer<typeof UpdateVehicleInspectionOutputSchema>;
