...
import { VehicleInspectionController } from '@modules/vehicle-inspection/vehicle-inspection.controller.js';
import { VehicleInspectionService } from '@modules/vehicle-inspection/vehicle-inspection.service.js';
import { VehicleInspectionRepository } from '@modules/vehicle-inspection/vehicle-inspection.repository.js';
import { pre } from './update-vehicle-inspection.pre.js';
import { process } from './update-vehicle-inspection.process.js';
import { post } from './update-vehicle-inspection.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/vehicle-inspections'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('VehicleInspection — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a VehicleInspection in the database', async () => {
...
describe('VehicleInspection — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /vehicle-inspections/:id responds with expected status', async () => {
    const res = await testApp.request('/vehicle-inspections/:id', {
      method: 'PATCH',
