...
import { pre } from './get-vehicle-inspection.pre.js';
import { process } from './get-vehicle-inspection.process.js';
import { post } from './get-vehicle-inspection.post.js';
...
describe('VehicleInspection — GET lifecycle unit tests', () => {
...
describe('VehicleInspection — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicle-inspections/:id responds with expected status', async () => {
