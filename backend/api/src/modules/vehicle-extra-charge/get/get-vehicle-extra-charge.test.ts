...
import { pre } from './get-vehicle-extra-charge.pre.js';
import { process } from './get-vehicle-extra-charge.process.js';
import { post } from './get-vehicle-extra-charge.post.js';
...
describe('VehicleExtraCharge — GET lifecycle unit tests', () => {
...
describe('VehicleExtraCharge — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicle-extra-charges/:id responds with expected status', async () => {
