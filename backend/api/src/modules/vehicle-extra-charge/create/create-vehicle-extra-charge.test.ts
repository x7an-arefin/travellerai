...
import { pre } from './create-vehicle-extra-charge.pre.js';
import { process } from './create-vehicle-extra-charge.process.js';
import { post } from './create-vehicle-extra-charge.post.js';
...
describe('VehicleExtraCharge — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehicleExtraCharge in the database', async () => {
...
describe('VehicleExtraCharge — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-extra-charges responds with expected status', async () => {
    const res = await testApp.request('/vehicle-extra-charges', {
      method: 'POST',
