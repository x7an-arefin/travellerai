...
export const CreateVehicleExtraChargeOutputSchema = VehicleExtraChargeBaseSchema;


export type CreateVehicleExtraChargeOutput = z.infer<typeof CreateVehicleExtraChargeOutputSchema>;
