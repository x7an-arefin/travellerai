...
import { pre } from './delete-vehicle-extra-charge.pre.js';
import { process } from './delete-vehicle-extra-charge.process.js';
import { post } from './delete-vehicle-extra-charge.post.js';
...
describe('VehicleExtraCharge — DELETE lifecycle unit tests', () => {
...
describe('VehicleExtraCharge — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-extra-charges/:id responds with expected status', async () => {
