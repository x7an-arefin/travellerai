...
import { pre } from './list-vehicle-extra-charge.pre.js';
import { process } from './list-vehicle-extra-charge.process.js';
import { post } from './list-vehicle-extra-charge.post.js';
...
describe('VehicleExtraCharge — LIST lifecycle unit tests', () => {
...
describe('VehicleExtraCharge — LIST controller integration tests', () => {
   ...
   */
  it('GET /vehicle-extra-charges responds with expected status', async () => {
