...
export const ListVehicleExtraChargeOutputSchema = z.object({
  items: z.array(VehicleExtraChargeBaseSchema),
  nextCursor: z.string().nullable(),
  hasMore: z.boolean(),
});


export type ListVehicleExtraChargeOutput = z.infer<typeof ListVehicleExtraChargeOutputSchema>;
