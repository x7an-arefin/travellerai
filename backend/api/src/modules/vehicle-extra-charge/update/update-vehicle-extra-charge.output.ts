...
export const UpdateVehicleExtraChargeOutputSchema = VehicleExtraChargeBaseSchema;


export type UpdateVehicleExtraChargeOutput = z.infer<typeof UpdateVehicleExtraChargeOutputSchema>;
