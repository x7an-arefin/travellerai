...
import { HotelPropertyController } from '@modules/hotel-property/hotel-property.controller.js';
import { HotelPropertyService } from '@modules/hotel-property/hotel-property.service.js';
import { HotelPropertyRepository } from '@modules/hotel-property/hotel-property.repository.js';
import { pre } from './update-hotel-property.pre.js';
import { process } from './update-hotel-property.process.js';
import { post } from './update-hotel-property.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/hotel-properties'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('HotelProperty — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a HotelProperty in the database', async () => {
...
describe('HotelProperty — UPDATE controller integration tests', () => {
  ...
  beforeEach(async () => {
    testApp = await createControllerTestApplication({
      controller: HotelPropertyController,
   ...
   */
  it('PATCH /hotel-properties/:id responds with expected status', async () => {
    const res = await testApp.request('/hotel-properties/:id', {
      method: 'PATCH',
