...
export const UpdateHotelPropertyOutputSchema = HotelPropertyBaseSchema;


export type UpdateHotelPropertyOutput = z.infer<typeof UpdateHotelPropertyOutputSchema>;
