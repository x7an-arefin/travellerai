...
import { pre } from './get-hotel-property.pre.js';
import { process } from './get-hotel-property.process.js';
import { post } from './get-hotel-property.post.js';
...
describe('HotelProperty — GET lifecycle unit tests', () => {
...
describe('HotelProperty — GET controller integration tests', () => {
   ...
   */
  it('GET /hotel-properties/:id responds with expected status', async () => {
