...
import { pre } from './delete-hotel-property.pre.js';
import { process } from './delete-hotel-property.process.js';
import { post } from './delete-hotel-property.post.js';
...
describe('HotelProperty — DELETE lifecycle unit tests', () => {
...
describe('HotelProperty — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /hotel-properties/:id responds with expected status', async () => {
