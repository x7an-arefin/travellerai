...
import { pre } from './list-hotel-property.pre.js';
import { process } from './list-hotel-property.process.js';
import { post } from './list-hotel-property.post.js';
...
describe('HotelProperty — LIST lifecycle unit tests', () => {
...
describe('HotelProperty — LIST controller integration tests', () => {
   ...
   */
  it('GET /hotel-properties responds with expected status', async () => {
