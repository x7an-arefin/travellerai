...
export const ListHotelPropertyOutputSchema = z.object({
  items: z.array(HotelPropertyBaseSchema),
  nextCursor: z.string().nullable(),
  hasMore: z.boolean(),
});


export type ListHotelPropertyOutput = z.infer<typeof ListHotelPropertyOutputSchema>;
