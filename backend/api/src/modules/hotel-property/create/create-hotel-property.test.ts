...
import { pre } from './create-hotel-property.pre.js';
import { process } from './create-hotel-property.process.js';
import { post } from './create-hotel-property.post.js';
...
describe('HotelProperty — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a HotelProperty in the database', async () => {
...
describe('HotelProperty — CREATE controller integration tests', () => {
   ...
   */
  it('POST /hotel-properties responds with expected status', async () => {
    const res = await testApp.request('/hotel-properties', {
      method: 'POST',
