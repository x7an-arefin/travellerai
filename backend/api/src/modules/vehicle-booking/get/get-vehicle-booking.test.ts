...
import { pre } from './get-vehicle-booking.pre.js';
import { process } from './get-vehicle-booking.process.js';
import { post } from './get-vehicle-booking.post.js';
...
describe('VehicleBooking — GET lifecycle unit tests', () => {
...
describe('VehicleBooking — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicle-bookings/:id responds with expected status', async () => {
