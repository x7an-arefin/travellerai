...
import { pre } from './list-vehicle-booking.pre.js';
import { process } from './list-vehicle-booking.process.js';
import { post } from './list-vehicle-booking.post.js';
...
describe('VehicleBooking — LIST lifecycle unit tests', () => {
...
describe('VehicleBooking — LIST controller integration tests', () => {
   ...
   */
  it('GET /vehicle-bookings responds with expected status', async () => {
