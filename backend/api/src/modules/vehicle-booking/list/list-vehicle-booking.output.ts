...
export const ListVehicleBookingOutputSchema = z.object({
  items: z.array(VehicleBookingBaseSchema),
  nextCursor: z.string().nullable(),
  hasMore: z.boolean(),
});


export type ListVehicleBookingOutput = z.infer<typeof ListVehicleBookingOutputSchema>;
