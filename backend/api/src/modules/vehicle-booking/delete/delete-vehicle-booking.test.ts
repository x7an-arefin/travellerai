...
import { pre } from './delete-vehicle-booking.pre.js';
import { process } from './delete-vehicle-booking.process.js';
import { post } from './delete-vehicle-booking.post.js';
...
describe('VehicleBooking — DELETE lifecycle unit tests', () => {
...
describe('VehicleBooking — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-bookings/:id responds with expected status', async () => {
