...
import { VehicleBookingController } from '@modules/vehicle-booking/vehicle-booking.controller.js';
import { VehicleBookingService } from '@modules/vehicle-booking/vehicle-booking.service.js';
import { VehicleBookingRepository } from '@modules/vehicle-booking/vehicle-booking.repository.js';
import { pre } from './update-vehicle-booking.pre.js';
import { process } from './update-vehicle-booking.process.js';
import { post } from './update-vehicle-booking.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/vehicle-bookings'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('VehicleBooking — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a VehicleBooking in the database', async () => {
...
describe('VehicleBooking — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /vehicle-bookings/:id responds with expected status', async () => {
    const res = await testApp.request('/vehicle-bookings/:id', {
      method: 'PATCH',
