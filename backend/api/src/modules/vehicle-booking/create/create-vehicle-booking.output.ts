...
export const CreateVehicleBookingOutputSchema = VehicleBookingBaseSchema;


export type CreateVehicleBookingOutput = z.infer<typeof CreateVehicleBookingOutputSchema>;
