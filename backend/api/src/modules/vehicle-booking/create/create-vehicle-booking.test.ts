...
import { pre } from './create-vehicle-booking.pre.js';
import { process } from './create-vehicle-booking.process.js';
import { post } from './create-vehicle-booking.post.js';
...
describe('VehicleBooking — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehicleBooking in the database', async () => {
...
describe('VehicleBooking — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-bookings responds with expected status', async () => {
    const res = await testApp.request('/vehicle-bookings', {
      method: 'POST',
