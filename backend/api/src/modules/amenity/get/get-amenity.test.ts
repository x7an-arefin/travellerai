...
import { pre } from './get-amenity.pre.js';
import { process } from './get-amenity.process.js';
import { post } from './get-amenity.post.js';
...
describe('Amenity — GET lifecycle unit tests', () => {
...
describe('Amenity — GET controller integration tests', () => {
   ...
   */
  it('GET /amenities/:id responds with expected status', async () => {
