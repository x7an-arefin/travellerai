...
import { pre } from './create-amenity.pre.js';
import { process } from './create-amenity.process.js';
import { post } from './create-amenity.post.js';
...
describe('Amenity — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a Amenity in the database', async () => {
...
describe('Amenity — CREATE controller integration tests', () => {
   ...
   */
  it('POST /amenities responds with expected status', async () => {
