...
import { pre } from './update-amenity.pre.js';
import { process } from './update-amenity.process.js';
import { post } from './update-amenity.post.js';
...
describe('Amenity — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a Amenity in the database', async () => {
...
describe('Amenity — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /amenities/:id responds with expected status', async () => {
    const res = await testApp.request('/amenities/:id', {
      method: 'PATCH',
