...
import { pre } from './delete-amenity.pre.js';
import { process } from './delete-amenity.process.js';
import { post } from './delete-amenity.post.js';
...
describe('Amenity — DELETE lifecycle unit tests', () => {
...
describe('Amenity — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /amenities/:id responds with expected status', async () => {
