...
import { pre } from './delete-provider-quotation.pre.js';
import { process } from './delete-provider-quotation.process.js';
import { post } from './delete-provider-quotation.post.js';
...
describe('ProviderQuotation — DELETE lifecycle unit tests', () => {
...
describe('ProviderQuotation — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /provider-quotations/:id responds with expected status', async () => {
