...
import { pre } from './list-provider-quotation.pre.js';
import { process } from './list-provider-quotation.process.js';
import { post } from './list-provider-quotation.post.js';
...
describe('ProviderQuotation — LIST lifecycle unit tests', () => {
...
describe('ProviderQuotation — LIST controller integration tests', () => {
   ...
   */
  it('GET /provider-quotations responds with expected status', async () => {
