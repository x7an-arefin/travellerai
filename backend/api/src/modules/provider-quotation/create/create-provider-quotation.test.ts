...
import { pre } from './create-provider-quotation.pre.js';
import { process } from './create-provider-quotation.process.js';
import { post } from './create-provider-quotation.post.js';
...
describe('ProviderQuotation — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a ProviderQuotation in the database', async () => {
...
describe('ProviderQuotation — CREATE controller integration tests', () => {
   ...
   */
  it('POST /provider-quotations responds with expected status', async () => {
    const res = await testApp.request('/provider-quotations', {
      method: 'POST',
