...
import { pre } from './get-provider-quotation.pre.js';
import { process } from './get-provider-quotation.process.js';
import { post } from './get-provider-quotation.post.js';
...
describe('ProviderQuotation — GET lifecycle unit tests', () => {
...
describe('ProviderQuotation — GET controller integration tests', () => {
   ...
   */
  it('GET /provider-quotations/:id responds with expected status', async () => {
