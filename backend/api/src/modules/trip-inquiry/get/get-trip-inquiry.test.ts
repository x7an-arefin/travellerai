...
import { pre } from './get-trip-inquiry.pre.js';
import { process } from './get-trip-inquiry.process.js';
import { post } from './get-trip-inquiry.post.js';
...
describe('TripInquiry — GET lifecycle unit tests', () => {
...
describe('TripInquiry — GET controller integration tests', () => {
   ...
   */
  it('GET /trip-inquiries/:id responds with expected status', async () => {
