...
import { pre } from './update-trip-inquiry.pre.js';
import { process } from './update-trip-inquiry.process.js';
import { post } from './update-trip-inquiry.post.js';
...
describe('TripInquiry — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a TripInquiry in the database', async () => {
...
describe('TripInquiry — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /trip-inquiries/:id responds with expected status', async () => {
