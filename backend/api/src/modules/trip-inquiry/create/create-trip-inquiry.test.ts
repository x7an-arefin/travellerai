...
import { pre } from './create-trip-inquiry.pre.js';
import { process } from './create-trip-inquiry.process.js';
import { post } from './create-trip-inquiry.post.js';
...
describe('TripInquiry — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a TripInquiry in the database', async () => {
...
describe('TripInquiry — CREATE controller integration tests', () => {
   ...
   */
  it('POST /trip-inquiries responds with expected status', async () => {
    const res = await testApp.request('/trip-inquiries', {
      method: 'POST',
