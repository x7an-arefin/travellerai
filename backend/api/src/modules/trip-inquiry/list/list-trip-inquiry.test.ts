...
import { pre } from './list-trip-inquiry.pre.js';
import { process } from './list-trip-inquiry.process.js';
import { post } from './list-trip-inquiry.post.js';
...
describe('TripInquiry — LIST lifecycle unit tests', () => {
...
describe('TripInquiry — LIST controller integration tests', () => {
   ...
   */
  it('GET /trip-inquiries responds with expected status', async () => {
