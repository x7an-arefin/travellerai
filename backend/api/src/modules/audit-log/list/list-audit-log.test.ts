...
import { pre } from './list-audit-log.pre.js';
import { process } from './list-audit-log.process.js';
import { post } from './list-audit-log.post.js';
...
describe('AuditLog — LIST lifecycle unit tests', () => {
...
describe('AuditLog — LIST controller integration tests', () => {
   ...
   */
  it('GET /audit-logs responds with expected status', async () => {
