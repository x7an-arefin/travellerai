...
import { pre } from './get-audit-log.pre.js';
import { process } from './get-audit-log.process.js';
import { post } from './get-audit-log.post.js';
...
describe('AuditLog — GET lifecycle unit tests', () => {
...
describe('AuditLog — GET controller integration tests', () => {
   ...
   */
  it('GET /audit-logs/:id responds with expected status', async () => {
    const res = await testApp.request('/audit-logs/:id', {
      method: 'GET',
