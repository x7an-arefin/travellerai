...
import { pre } from './delete-vehicle-compliance-doc.pre.js';
import { process } from './delete-vehicle-compliance-doc.process.js';
import { post } from './delete-vehicle-compliance-doc.post.js';
...
describe('VehicleComplianceDoc — DELETE lifecycle unit tests', () => {
...
describe('VehicleComplianceDoc — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-compliance-docs/:id responds with expected status', async () => {
