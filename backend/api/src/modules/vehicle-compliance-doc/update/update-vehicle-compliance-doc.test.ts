...
import { VehicleComplianceDocController } from '@modules/vehicle-compliance-doc/vehicle-compliance-doc.controller.js';
import { VehicleComplianceDocService } from '@modules/vehicle-compliance-doc/vehicle-compliance-doc.service.js';
import { VehicleComplianceDocRepository } from '@modules/vehicle-compliance-doc/vehicle-compliance-doc.repository.js';
import { pre } from './update-vehicle-compliance-doc.pre.js';
import { process } from './update-vehicle-compliance-doc.process.js';
import { post } from './update-vehicle-compliance-doc.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/vehicle-compliance-docs'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('VehicleComplianceDoc — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a VehicleComplianceDoc in the database', async () => {
...
describe('VehicleComplianceDoc — UPDATE controller integration tests', () => {
  ...
  beforeEach(async () => {
    testApp = await createControllerTestApplication({
      controller: VehicleComplianceDocController,
   ...
   */
  it('PATCH /vehicle-compliance-docs/:id responds with expected status', async () => {
    const res = await testApp.request('/vehicle-compliance-docs/:id', {
      method: 'PATCH',
