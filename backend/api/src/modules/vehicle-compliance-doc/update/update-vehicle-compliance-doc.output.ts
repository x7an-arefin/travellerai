...
export const UpdateVehicleComplianceDocOutputSchema = VehicleComplianceDocBaseSchema;


export type UpdateVehicleComplianceDocOutput = z.infer<typeof UpdateVehicleComplianceDocOutputSchema>;
