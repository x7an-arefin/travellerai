...
import { pre } from './list-vehicle-compliance-doc.pre.js';
import { process } from './list-vehicle-compliance-doc.process.js';
import { post } from './list-vehicle-compliance-doc.post.js';
...
describe('VehicleComplianceDoc — LIST lifecycle unit tests', () => {
...
describe('VehicleComplianceDoc — LIST controller integration tests', () => {
   ...
   */
  it('GET /vehicle-compliance-docs responds with expected status', async () => {
