...
export const CreateVehicleComplianceDocOutputSchema = VehicleComplianceDocBaseSchema;


export type CreateVehicleComplianceDocOutput = z.infer<typeof CreateVehicleComplianceDocOutputSchema>;
