...
import { pre } from './create-vehicle-compliance-doc.pre.js';
import { process } from './create-vehicle-compliance-doc.process.js';
import { post } from './create-vehicle-compliance-doc.post.js';
...
describe('VehicleComplianceDoc — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehicleComplianceDoc in the database', async () => {
...
describe('VehicleComplianceDoc — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-compliance-docs responds with expected status', async () => {
    const res = await testApp.request('/vehicle-compliance-docs', {
      method: 'POST',
