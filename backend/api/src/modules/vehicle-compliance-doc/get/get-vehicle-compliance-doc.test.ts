...
import { pre } from './get-vehicle-compliance-doc.pre.js';
import { process } from './get-vehicle-compliance-doc.process.js';
import { post } from './get-vehicle-compliance-doc.post.js';
...
describe('VehicleComplianceDoc — GET lifecycle unit tests', () => {
...
describe('VehicleComplianceDoc — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicle-compliance-docs/:id responds with expected status', async () => {
