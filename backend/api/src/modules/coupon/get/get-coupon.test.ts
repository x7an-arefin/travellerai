...
import { pre } from './get-coupon.pre.js';
import { process } from './get-coupon.process.js';
import { post } from './get-coupon.post.js';
...
describe('Coupon — GET lifecycle unit tests', () => {
...
describe('Coupon — GET controller integration tests', () => {
   ...
   */
  it('GET /coupons/:id responds with expected status', async () => {
