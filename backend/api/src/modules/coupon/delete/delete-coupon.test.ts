...
import { pre } from './delete-coupon.pre.js';
import { process } from './delete-coupon.process.js';
import { post } from './delete-coupon.post.js';
...
describe('Coupon — DELETE lifecycle unit tests', () => {
...
describe('Coupon — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /coupons/:id responds with expected status', async () => {
