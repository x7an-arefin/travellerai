...
import { pre } from './create-coupon.pre.js';
import { process } from './create-coupon.process.js';
import { post } from './create-coupon.post.js';
...
describe('Coupon — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a Coupon in the database', async () => {
...
describe('Coupon — CREATE controller integration tests', () => {
   ...
   */
  it('POST /coupons responds with expected status', async () => {
    const res = await testApp.request('/coupons', {
      method: 'POST',
