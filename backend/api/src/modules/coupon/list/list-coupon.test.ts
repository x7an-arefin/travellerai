...
import { pre } from './list-coupon.pre.js';
import { process } from './list-coupon.process.js';
import { post } from './list-coupon.post.js';
...
describe('Coupon — LIST lifecycle unit tests', () => {
...
describe('Coupon — LIST controller integration tests', () => {
   ...
   */
  it('GET /coupons responds with expected status', async () => {
