...
import { pre } from './get-customer-wallet.pre.js';
import { process } from './get-customer-wallet.process.js';
import { post } from './get-customer-wallet.post.js';
...
describe('CustomerWallet — GET lifecycle unit tests', () => {
...
describe('CustomerWallet — GET controller integration tests', () => {
   ...
   */
  it('GET /customer-wallets/:id responds with expected status', async () => {
