...
import { pre } from './list-customer-wallet.pre.js';
import { process } from './list-customer-wallet.process.js';
import { post } from './list-customer-wallet.post.js';
...
describe('CustomerWallet — LIST lifecycle unit tests', () => {
...
describe('CustomerWallet — LIST controller integration tests', () => {
   ...
   */
  it('GET /customer-wallets responds with expected status', async () => {
