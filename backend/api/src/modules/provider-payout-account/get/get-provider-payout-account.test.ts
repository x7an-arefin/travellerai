...
import { pre } from './get-provider-payout-account.pre.js';
import { process } from './get-provider-payout-account.process.js';
import { post } from './get-provider-payout-account.post.js';
...
describe('ProviderPayoutAccount — GET lifecycle unit tests', () => {
...
describe('ProviderPayoutAccount — GET controller integration tests', () => {
   ...
   */
  it('GET /provider-payout-accounts/:id responds with expected status', async () => {
