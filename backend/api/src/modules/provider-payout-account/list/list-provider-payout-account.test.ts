...
import { pre } from './list-provider-payout-account.pre.js';
import { process } from './list-provider-payout-account.process.js';
import { post } from './list-provider-payout-account.post.js';
...
describe('ProviderPayoutAccount — LIST lifecycle unit tests', () => {
...
describe('ProviderPayoutAccount — LIST controller integration tests', () => {
   ...
   */
  it('GET /provider-payout-accounts responds with expected status', async () => {
