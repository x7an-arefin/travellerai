...
import { pre } from './create-provider-payout-account.pre.js';
import { process } from './create-provider-payout-account.process.js';
import { post } from './create-provider-payout-account.post.js';
...
describe('ProviderPayoutAccount — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a ProviderPayoutAccount in the database', async () => {
...
describe('ProviderPayoutAccount — CREATE controller integration tests', () => {
   ...
   */
  it('POST /provider-payout-accounts responds with expected status', async () => {
    const res = await testApp.request('/provider-payout-accounts', {
      method: 'POST',
