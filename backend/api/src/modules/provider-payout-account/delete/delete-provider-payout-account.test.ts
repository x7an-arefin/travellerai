...
import { pre } from './delete-provider-payout-account.pre.js';
import { process } from './delete-provider-payout-account.process.js';
import { post } from './delete-provider-payout-account.post.js';
...
describe('ProviderPayoutAccount — DELETE lifecycle unit tests', () => {
...
describe('ProviderPayoutAccount — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /provider-payout-accounts/:id responds with expected status', async () => {
