...
import { pre } from './delete-category.pre.js';
import { process } from './delete-category.process.js';
import { post } from './delete-category.post.js';
...
describe('Category — DELETE lifecycle unit tests', () => {
...
describe('Category — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /categories/:id responds with expected status', async () => {
