...
import { pre } from './create-category.pre.js';
import { process } from './create-category.process.js';
import { post } from './create-category.post.js';
...
describe('Category — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a Category in the database', async () => {
...
describe('Category — CREATE controller integration tests', () => {
   ...
   */
  it('POST /categories responds with expected status', async () => {
    const res = await testApp.request('/categories', {
      method: 'POST',
