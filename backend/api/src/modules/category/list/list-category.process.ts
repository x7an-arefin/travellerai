...
/**
 * @author arefin
 * @description PROCESS lifecycle handler for LIST Category — executes the core business operation via the repository
 */
export async function process(ctx: LifecycleContext): Promise<LifecycleResult> {
  ...
  const result = await repo.findAll({
    ...
    parentId: ctx.input.parentId as string | undefined,
