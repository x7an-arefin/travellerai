...
import { pre } from './list-category.pre.js';
import { process } from './list-category.process.js';
import { post } from './list-category.post.js';
...
describe('Category — LIST lifecycle unit tests', () => {
...
describe('Category — LIST controller integration tests', () => {
   ...
   */
  it('GET /categories responds with expected status', async () => {
