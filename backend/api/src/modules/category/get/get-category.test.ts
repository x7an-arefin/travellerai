...
import { pre } from './get-category.pre.js';
import { process } from './get-category.process.js';
import { post } from './get-category.post.js';
...
describe('Category — GET lifecycle unit tests', () => {
...
describe('Category — GET controller integration tests', () => {
   ...
   */
  it('GET /categories/:id responds with expected status', async () => {
