...
import { pre } from './delete-support-ticket.pre.js';
import { process } from './delete-support-ticket.process.js';
import { post } from './delete-support-ticket.post.js';
...
describe('SupportTicket — DELETE lifecycle unit tests', () => {
...
describe('SupportTicket — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /support-tickets/:id responds with expected status', async () => {
