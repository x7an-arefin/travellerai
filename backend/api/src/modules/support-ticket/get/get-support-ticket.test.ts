...
import { pre } from './get-support-ticket.pre.js';
import { process } from './get-support-ticket.process.js';
import { post } from './get-support-ticket.post.js';
...
describe('SupportTicket — GET lifecycle unit tests', () => {
...
describe('SupportTicket — GET controller integration tests', () => {
   ...
   */
  it('GET /support-tickets/:id responds with expected status', async () => {
