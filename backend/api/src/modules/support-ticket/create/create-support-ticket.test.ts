...
import { pre } from './create-support-ticket.pre.js';
import { process } from './create-support-ticket.process.js';
import { post } from './create-support-ticket.post.js';
...
describe('SupportTicket — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a SupportTicket in the database', async () => {
...
describe('SupportTicket — CREATE controller integration tests', () => {
   ...
   */
  it('POST /support-tickets responds with expected status', async () => {
    const res = await testApp.request('/support-tickets', {
      method: 'POST',
