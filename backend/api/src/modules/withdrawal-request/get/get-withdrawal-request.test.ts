...
import { pre } from './get-withdrawal-request.pre.js';
import { process } from './get-withdrawal-request.process.js';
import { post } from './get-withdrawal-request.post.js';
...
describe('WithdrawalRequest — GET lifecycle unit tests', () => {
...
describe('WithdrawalRequest — GET controller integration tests', () => {
   ...
   */
  it('GET /withdrawal-requests/:id responds with expected status', async () => {
