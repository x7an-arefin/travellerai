...
import { pre } from './delete-withdrawal-request.pre.js';
import { process } from './delete-withdrawal-request.process.js';
import { post } from './delete-withdrawal-request.post.js';
...
describe('WithdrawalRequest — DELETE lifecycle unit tests', () => {
...
describe('WithdrawalRequest — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /withdrawal-requests/:id responds with expected status', async () => {
