...
import { pre } from './create-withdrawal-request.pre.js';
import { process } from './create-withdrawal-request.process.js';
import { post } from './create-withdrawal-request.post.js';
...
describe('WithdrawalRequest — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a WithdrawalRequest in the database', async () => {
...
describe('WithdrawalRequest — CREATE controller integration tests', () => {
   ...
   */
  it('POST /withdrawal-requests responds with expected status', async () => {
    const res = await testApp.request('/withdrawal-requests', {
      method: 'POST',
