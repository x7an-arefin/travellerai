...
import { pre } from './list-withdrawal-request.pre.js';
import { process } from './list-withdrawal-request.process.js';
import { post } from './list-withdrawal-request.post.js';
...
describe('WithdrawalRequest — LIST lifecycle unit tests', () => {
...
describe('WithdrawalRequest — LIST controller integration tests', () => {
   ...
   */
  it('GET /withdrawal-requests responds with expected status', async () => {
