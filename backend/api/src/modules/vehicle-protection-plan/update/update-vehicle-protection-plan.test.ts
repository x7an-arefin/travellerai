...
import { pre } from './update-vehicle-protection-plan.pre.js';
import { process } from './update-vehicle-protection-plan.process.js';
import { post } from './update-vehicle-protection-plan.post.js';
...
describe('VehicleProtectionPlan — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a VehicleProtectionPlan in the database', async () => {
...
describe('VehicleProtectionPlan — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /vehicle-protection-plans/:id responds with expected status', async () => {
    const res = await testApp.request('/vehicle-protection-plans/:id', {
      method: 'PATCH',
