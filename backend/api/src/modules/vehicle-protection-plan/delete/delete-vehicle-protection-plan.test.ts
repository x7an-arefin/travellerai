...
import { pre } from './delete-vehicle-protection-plan.pre.js';
import { process } from './delete-vehicle-protection-plan.process.js';
import { post } from './delete-vehicle-protection-plan.post.js';
...
describe('VehicleProtectionPlan — DELETE lifecycle unit tests', () => {
...
describe('VehicleProtectionPlan — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-protection-plans/:id responds with expected status', async () => {
