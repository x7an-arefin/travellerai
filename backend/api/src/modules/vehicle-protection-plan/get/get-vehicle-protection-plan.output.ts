...
export const GetVehicleProtectionPlanOutputSchema = VehicleProtectionPlanBaseSchema;


export type GetVehicleProtectionPlanOutput = z.infer<typeof GetVehicleProtectionPlanOutputSchema>;
