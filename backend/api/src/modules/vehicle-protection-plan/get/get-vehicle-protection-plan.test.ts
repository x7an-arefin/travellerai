...
import { pre } from './get-vehicle-protection-plan.pre.js';
import { process } from './get-vehicle-protection-plan.process.js';
import { post } from './get-vehicle-protection-plan.post.js';
...
describe('VehicleProtectionPlan — GET lifecycle unit tests', () => {
...
describe('VehicleProtectionPlan — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicle-protection-plans/:id responds with expected status', async () => {
