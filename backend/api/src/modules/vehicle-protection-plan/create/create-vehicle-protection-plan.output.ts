...
export const CreateVehicleProtectionPlanOutputSchema = VehicleProtectionPlanBaseSchema;


export type CreateVehicleProtectionPlanOutput = z.infer<typeof CreateVehicleProtectionPlanOutputSchema>;
