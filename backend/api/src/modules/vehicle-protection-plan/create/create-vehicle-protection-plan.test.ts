...
import { pre } from './create-vehicle-protection-plan.pre.js';
import { process } from './create-vehicle-protection-plan.process.js';
import { post } from './create-vehicle-protection-plan.post.js';
...
describe('VehicleProtectionPlan — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehicleProtectionPlan in the database', async () => {
...
describe('VehicleProtectionPlan — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-protection-plans responds with expected status', async () => {
