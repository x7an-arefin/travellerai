...
import { pre } from './list-room-unit.pre.js';
import { process } from './list-room-unit.process.js';
import { post } from './list-room-unit.post.js';
...
describe('RoomUnit — LIST lifecycle unit tests', () => {
...
describe('RoomUnit — LIST controller integration tests', () => {
   ...
   */
  it('GET /room-units responds with expected status', async () => {
