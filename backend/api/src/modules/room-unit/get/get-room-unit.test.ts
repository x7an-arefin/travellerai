...
import { pre } from './get-room-unit.pre.js';
import { process } from './get-room-unit.process.js';
import { post } from './get-room-unit.post.js';
...
describe('RoomUnit — GET lifecycle unit tests', () => {
...
describe('RoomUnit — GET controller integration tests', () => {
   ...
   */
  it('GET /room-units/:id responds with expected status', async () => {
