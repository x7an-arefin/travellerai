...
import { pre } from './delete-room-unit.pre.js';
import { process } from './delete-room-unit.process.js';
import { post } from './delete-room-unit.post.js';
...
describe('RoomUnit — DELETE lifecycle unit tests', () => {
...
describe('RoomUnit — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /room-units/:id responds with expected status', async () => {
