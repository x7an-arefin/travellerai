...
import { pre } from './create-room-unit.pre.js';
import { process } from './create-room-unit.process.js';
import { post } from './create-room-unit.post.js';
...
describe('RoomUnit — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a RoomUnit in the database', async () => {
...
describe('RoomUnit — CREATE controller integration tests', () => {
   ...
   */
  it('POST /room-units responds with expected status', async () => {
    const res = await testApp.request('/room-units', {
      method: 'POST',
