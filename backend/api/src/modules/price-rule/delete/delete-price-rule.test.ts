...
import { pre } from './delete-price-rule.pre.js';
import { process } from './delete-price-rule.process.js';
import { post } from './delete-price-rule.post.js';
...
describe('PriceRule — DELETE lifecycle unit tests', () => {
...
describe('PriceRule — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /price-rules/:id responds with expected status', async () => {
