...
import { pre } from './create-price-rule.pre.js';
import { process } from './create-price-rule.process.js';
import { post } from './create-price-rule.post.js';
...
describe('PriceRule — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a PriceRule in the database', async () => {
...
describe('PriceRule — CREATE controller integration tests', () => {
   ...
   */
  it('POST /price-rules responds with expected status', async () => {
    const res = await testApp.request('/price-rules', {
      method: 'POST',
