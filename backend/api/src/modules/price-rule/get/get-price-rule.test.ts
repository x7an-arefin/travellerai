...
import { pre } from './get-price-rule.pre.js';
import { process } from './get-price-rule.process.js';
import { post } from './get-price-rule.post.js';
...
describe('PriceRule — GET lifecycle unit tests', () => {
...
describe('PriceRule — GET controller integration tests', () => {
   ...
   */
  it('GET /price-rules/:id responds with expected status', async () => {
