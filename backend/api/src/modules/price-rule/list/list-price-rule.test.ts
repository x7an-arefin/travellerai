...
import { pre } from './list-price-rule.pre.js';
import { process } from './list-price-rule.process.js';
import { post } from './list-price-rule.post.js';
...
describe('PriceRule — LIST lifecycle unit tests', () => {
...
describe('PriceRule — LIST controller integration tests', () => {
   ...
   */
  it('GET /price-rules responds with expected status', async () => {
