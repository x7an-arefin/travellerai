...
import { pre } from './create-vehicle.pre.js';
import { process } from './create-vehicle.process.js';
import { post } from './create-vehicle.post.js';
...
describe('Vehicle — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a Vehicle in the database', async () => {
...
describe('Vehicle — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicles responds with expected status', async () => {
    const res = await testApp.request('/vehicles', {
      method: 'POST',
