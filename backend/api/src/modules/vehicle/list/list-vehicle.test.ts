...
import { pre } from './list-vehicle.pre.js';
import { process } from './list-vehicle.process.js';
import { post } from './list-vehicle.post.js';
...
describe('Vehicle — LIST lifecycle unit tests', () => {
...
describe('Vehicle — LIST controller integration tests', () => {
   ...
   */
  it('GET /vehicles responds with expected status', async () => {
