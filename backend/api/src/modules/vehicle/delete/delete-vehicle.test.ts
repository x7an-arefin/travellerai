...
import { pre } from './delete-vehicle.pre.js';
import { process } from './delete-vehicle.process.js';
import { post } from './delete-vehicle.post.js';
...
describe('Vehicle — DELETE lifecycle unit tests', () => {
...
describe('Vehicle — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicles/:id responds with expected status', async () => {
