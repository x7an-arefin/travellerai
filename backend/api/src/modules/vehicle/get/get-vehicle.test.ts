...
import { pre } from './get-vehicle.pre.js';
import { process } from './get-vehicle.process.js';
import { post } from './get-vehicle.post.js';
...
describe('Vehicle — GET lifecycle unit tests', () => {
...
describe('Vehicle — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicles/:id responds with expected status', async () => {
