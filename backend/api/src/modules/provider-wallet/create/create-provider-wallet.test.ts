...
import { pre } from './create-provider-wallet.pre.js';
import { process } from './create-provider-wallet.process.js';
import { post } from './create-provider-wallet.post.js';
...
describe('ProviderWallet — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a ProviderWallet in the database', async () => {
...
describe('ProviderWallet — CREATE controller integration tests', () => {
   ...
   */
  it('POST /provider-wallets responds with expected status', async () => {
    const res = await testApp.request('/provider-wallets', {
      method: 'POST',
