...
import { pre } from './get-provider-wallet.pre.js';
import { process } from './get-provider-wallet.process.js';
import { post } from './get-provider-wallet.post.js';
...
describe('ProviderWallet — GET lifecycle unit tests', () => {
...
describe('ProviderWallet — GET controller integration tests', () => {
   ...
   */
  it('GET /provider-wallets/:id responds with expected status', async () => {
