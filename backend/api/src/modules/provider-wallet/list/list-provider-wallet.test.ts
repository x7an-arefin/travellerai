...
import { pre } from './list-provider-wallet.pre.js';
import { process } from './list-provider-wallet.process.js';
import { post } from './list-provider-wallet.post.js';
...
describe('ProviderWallet — LIST lifecycle unit tests', () => {
...
describe('ProviderWallet — LIST controller integration tests', () => {
   ...
   */
  it('GET /provider-wallets responds with expected status', async () => {
