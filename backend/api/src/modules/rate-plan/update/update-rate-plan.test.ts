...
import { pre } from './update-rate-plan.pre.js';
import { process } from './update-rate-plan.process.js';
import { post } from './update-rate-plan.post.js';
...
describe('RatePlan — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a RatePlan in the database', async () => {
...
describe('RatePlan — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /rate-plans/:id responds with expected status', async () => {
