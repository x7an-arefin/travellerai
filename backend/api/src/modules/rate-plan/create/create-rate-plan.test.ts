...
import { pre } from './create-rate-plan.pre.js';
import { process } from './create-rate-plan.process.js';
import { post } from './create-rate-plan.post.js';
...
describe('RatePlan — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a RatePlan in the database', async () => {
...
describe('RatePlan — CREATE controller integration tests', () => {
   ...
   */
  it('POST /rate-plans responds with expected status', async () => {
    const res = await testApp.request('/rate-plans', {
      method: 'POST',
