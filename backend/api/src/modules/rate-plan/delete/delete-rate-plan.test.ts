...
import { pre } from './delete-rate-plan.pre.js';
import { process } from './delete-rate-plan.process.js';
import { post } from './delete-rate-plan.post.js';
...
describe('RatePlan — DELETE lifecycle unit tests', () => {
...
describe('RatePlan — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /rate-plans/:id responds with expected status', async () => {
