...
import { pre } from './list-rate-plan.pre.js';
import { process } from './list-rate-plan.process.js';
import { post } from './list-rate-plan.post.js';
...
describe('RatePlan — LIST lifecycle unit tests', () => {
...
describe('RatePlan — LIST controller integration tests', () => {
   ...
   */
  it('GET /rate-plans responds with expected status', async () => {
