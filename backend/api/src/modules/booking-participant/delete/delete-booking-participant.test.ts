...
import { pre } from './delete-booking-participant.pre.js';
import { process } from './delete-booking-participant.process.js';
import { post } from './delete-booking-participant.post.js';
...
describe('BookingParticipant — DELETE lifecycle unit tests', () => {
...
describe('BookingParticipant — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /booking-participants/:id responds with expected status', async () => {
