...
import { pre } from './get-booking-participant.pre.js';
import { process } from './get-booking-participant.process.js';
import { post } from './get-booking-participant.post.js';
...
describe('BookingParticipant — GET lifecycle unit tests', () => {
...
describe('BookingParticipant — GET controller integration tests', () => {
   ...
   */
  it('GET /booking-participants/:id responds with expected status', async () => {
