...
import { pre } from './create-booking-participant.pre.js';
import { process } from './create-booking-participant.process.js';
import { post } from './create-booking-participant.post.js';
...
describe('BookingParticipant — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a BookingParticipant in the database', async () => {
...
describe('BookingParticipant — CREATE controller integration tests', () => {
   ...
   */
  it('POST /booking-participants responds with expected status', async () => {
    const res = await testApp.request('/booking-participants', {
      method: 'POST',
