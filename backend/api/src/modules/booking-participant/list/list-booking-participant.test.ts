...
import { pre } from './list-booking-participant.pre.js';
import { process } from './list-booking-participant.process.js';
import { post } from './list-booking-participant.post.js';
...
describe('BookingParticipant — LIST lifecycle unit tests', () => {
...
describe('BookingParticipant — LIST controller integration tests', () => {
   ...
   */
  it('GET /booking-participants responds with expected status', async () => {
