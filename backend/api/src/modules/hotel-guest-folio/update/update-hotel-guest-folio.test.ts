...
import { pre } from './update-hotel-guest-folio.pre.js';
import { process } from './update-hotel-guest-folio.process.js';
import { post } from './update-hotel-guest-folio.post.js';
...
describe('HotelGuestFolio — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a HotelGuestFolio in the database', async () => {
...
describe('HotelGuestFolio — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /hotel-guest-folios/:id responds with expected status', async () => {
