...
import { pre } from './list-hotel-guest-folio.pre.js';
import { process } from './list-hotel-guest-folio.process.js';
import { post } from './list-hotel-guest-folio.post.js';
...
describe('HotelGuestFolio — LIST lifecycle unit tests', () => {
...
describe('HotelGuestFolio — LIST controller integration tests', () => {
   ...
   */
  it('GET /hotel-guest-folios responds with expected status', async () => {
