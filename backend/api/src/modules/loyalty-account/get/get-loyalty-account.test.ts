...
import { pre } from './get-loyalty-account.pre.js';
import { process } from './get-loyalty-account.process.js';
import { post } from './get-loyalty-account.post.js';
...
describe('LoyaltyAccount — GET lifecycle unit tests', () => {
...
describe('LoyaltyAccount — GET controller integration tests', () => {
   ...
   */
  it('GET /loyalty-accounts/:id responds with expected status', async () => {
