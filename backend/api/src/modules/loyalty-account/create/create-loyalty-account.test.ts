...
import { pre } from './create-loyalty-account.pre.js';
import { process } from './create-loyalty-account.process.js';
import { post } from './create-loyalty-account.post.js';
...
describe('LoyaltyAccount — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a LoyaltyAccount in the database', async () => {
...
describe('LoyaltyAccount — CREATE controller integration tests', () => {
   ...
   */
  it('POST /loyalty-accounts responds with expected status', async () => {
    const res = await testApp.request('/loyalty-accounts', {
      method: 'POST',
