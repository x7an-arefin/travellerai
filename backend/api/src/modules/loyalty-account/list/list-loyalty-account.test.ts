...
import { pre } from './list-loyalty-account.pre.js';
import { process } from './list-loyalty-account.process.js';
import { post } from './list-loyalty-account.post.js';
...
describe('LoyaltyAccount — LIST lifecycle unit tests', () => {
...
describe('LoyaltyAccount — LIST controller integration tests', () => {
   ...
   */
  it('GET /loyalty-accounts responds with expected status', async () => {
