...
import { pre } from './get-vehicle-transfer-route.pre.js';
import { process } from './get-vehicle-transfer-route.process.js';
import { post } from './get-vehicle-transfer-route.post.js';
...
describe('VehicleTransferRoute — GET lifecycle unit tests', () => {
...
describe('VehicleTransferRoute — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicle-transfer-routes/:id responds with expected status', async () => {
