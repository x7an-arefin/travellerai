...
import { pre } from './create-vehicle-transfer-route.pre.js';
import { process } from './create-vehicle-transfer-route.process.js';
import { post } from './create-vehicle-transfer-route.post.js';
...
describe('VehicleTransferRoute — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehicleTransferRoute in the database', async () => {
...
describe('VehicleTransferRoute — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-transfer-routes responds with expected status', async () => {
