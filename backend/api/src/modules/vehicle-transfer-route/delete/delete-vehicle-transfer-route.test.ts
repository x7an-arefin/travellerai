...
import { pre } from './delete-vehicle-transfer-route.pre.js';
import { process } from './delete-vehicle-transfer-route.process.js';
import { post } from './delete-vehicle-transfer-route.post.js';
...
describe('VehicleTransferRoute — DELETE lifecycle unit tests', () => {
...
describe('VehicleTransferRoute — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-transfer-routes/:id responds with expected status', async () => {
