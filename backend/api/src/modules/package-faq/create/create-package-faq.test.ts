...
import { pre } from './create-package-faq.pre.js';
import { process } from './create-package-faq.process.js';
import { post } from './create-package-faq.post.js';
...
describe('PackageFaq — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a PackageFaq in the database', async () => {
...
describe('PackageFaq — CREATE controller integration tests', () => {
   ...
   */
  it('POST /package-faqs responds with expected status', async () => {
    const res = await testApp.request('/package-faqs', {
      method: 'POST',
