...
import { pre } from './delete-package-faq.pre.js';
import { process } from './delete-package-faq.process.js';
import { post } from './delete-package-faq.post.js';
...
describe('PackageFaq — DELETE lifecycle unit tests', () => {
...
describe('PackageFaq — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /package-faqs/:id responds with expected status', async () => {
