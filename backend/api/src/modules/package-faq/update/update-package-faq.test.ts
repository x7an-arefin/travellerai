...
import { PackageFaqController } from '@modules/package-faq/package-faq.controller.js';
import { PackageFaqService } from '@modules/package-faq/package-faq.service.js';
import { PackageFaqRepository } from '@modules/package-faq/package-faq.repository.js';
import { pre } from './update-package-faq.pre.js';
import { process } from './update-package-faq.process.js';
import { post } from './update-package-faq.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/package-faqs'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('PackageFaq — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a PackageFaq in the database', async () => {
...
describe('PackageFaq — UPDATE controller integration tests', () => {
  ...
  beforeEach(async () => {
    testApp = await createControllerTestApplication({
      controller: PackageFaqController,
   ...
   */
  it('PATCH /package-faqs/:id responds with expected status', async () => {
    const res = await testApp.request('/package-faqs/:id', {
      method: 'PATCH',
