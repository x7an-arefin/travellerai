...
import { pre } from './update-gift-card.pre.js';
import { process } from './update-gift-card.process.js';
import { post } from './update-gift-card.post.js';
...
describe('GiftCard — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a GiftCard in the database', async () => {
...
describe('GiftCard — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /gift-cards/:id responds with expected status', async () => {
