...
import { pre } from './delete-payment-transaction.pre.js';
import { process } from './delete-payment-transaction.process.js';
import { post } from './delete-payment-transaction.post.js';
...
describe('PaymentTransaction — DELETE lifecycle unit tests', () => {
...
describe('PaymentTransaction — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /payment-transactions/:id responds with expected status', async () => {
