...
import { pre } from './list-payment-transaction.pre.js';
import { process } from './list-payment-transaction.process.js';
import { post } from './list-payment-transaction.post.js';
...
describe('PaymentTransaction — LIST lifecycle unit tests', () => {
...
describe('PaymentTransaction — LIST controller integration tests', () => {
   ...
   */
  it('GET /payment-transactions responds with expected status', async () => {
