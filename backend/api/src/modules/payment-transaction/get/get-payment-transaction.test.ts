...
import { pre } from './get-payment-transaction.pre.js';
import { process } from './get-payment-transaction.process.js';
import { post } from './get-payment-transaction.post.js';
...
describe('PaymentTransaction — GET lifecycle unit tests', () => {
...
describe('PaymentTransaction — GET controller integration tests', () => {
   ...
   */
  it('GET /payment-transactions/:id responds with expected status', async () => {
