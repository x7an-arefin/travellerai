...
import { pre } from './create-payment-transaction.pre.js';
import { process } from './create-payment-transaction.process.js';
import { post } from './create-payment-transaction.post.js';
...
describe('PaymentTransaction — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a PaymentTransaction in the database', async () => {
...
describe('PaymentTransaction — CREATE controller integration tests', () => {
   ...
   */
  it('POST /payment-transactions responds with expected status', async () => {
    const res = await testApp.request('/payment-transactions', {
      method: 'POST',
