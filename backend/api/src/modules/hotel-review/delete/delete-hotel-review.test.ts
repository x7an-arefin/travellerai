...
import { pre } from './delete-hotel-review.pre.js';
import { process } from './delete-hotel-review.process.js';
import { post } from './delete-hotel-review.post.js';
...
describe('HotelReview — DELETE lifecycle unit tests', () => {
...
describe('HotelReview — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /hotel-reviews/:id responds with expected status', async () => {
