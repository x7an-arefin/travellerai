...
import { pre } from './get-hotel-review.pre.js';
import { process } from './get-hotel-review.process.js';
import { post } from './get-hotel-review.post.js';
...
describe('HotelReview — GET lifecycle unit tests', () => {
...
describe('HotelReview — GET controller integration tests', () => {
   ...
   */
  it('GET /hotel-reviews/:id responds with expected status', async () => {
