...
import { pre } from './list-hotel-review.pre.js';
import { process } from './list-hotel-review.process.js';
import { post } from './list-hotel-review.post.js';
...
describe('HotelReview — LIST lifecycle unit tests', () => {
...
describe('HotelReview — LIST controller integration tests', () => {
   ...
   */
  it('GET /hotel-reviews responds with expected status', async () => {
