...
import { HotelReviewController } from '@modules/hotel-review/hotel-review.controller.js';
import { HotelReviewService } from '@modules/hotel-review/hotel-review.service.js';
import { HotelReviewRepository } from '@modules/hotel-review/hotel-review.repository.js';
import { pre } from './update-hotel-review.pre.js';
import { process } from './update-hotel-review.process.js';
import { post } from './update-hotel-review.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/hotel-reviews'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('HotelReview — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a HotelReview in the database', async () => {
...
describe('HotelReview — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /hotel-reviews/:id responds with expected status', async () => {
    const res = await testApp.request('/hotel-reviews/:id', {
      method: 'PATCH',
