...
import { pre } from './create-hotel-review.pre.js';
import { process } from './create-hotel-review.process.js';
import { post } from './create-hotel-review.post.js';
...
describe('HotelReview — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a HotelReview in the database', async () => {
...
describe('HotelReview — CREATE controller integration tests', () => {
   ...
   */
  it('POST /hotel-reviews responds with expected status', async () => {
    const res = await testApp.request('/hotel-reviews', {
      method: 'POST',
