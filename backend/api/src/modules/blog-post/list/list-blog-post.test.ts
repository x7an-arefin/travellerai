...
import { pre } from './list-blog-post.pre.js';
import { process } from './list-blog-post.process.js';
import { post } from './list-blog-post.post.js';
...
describe('BlogPost — LIST lifecycle unit tests', () => {
...
describe('BlogPost — LIST controller integration tests', () => {
   ...
   */
  it('GET /blog-posts responds with expected status', async () => {
