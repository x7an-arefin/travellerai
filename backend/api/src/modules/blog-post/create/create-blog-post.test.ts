...
import { pre } from './create-blog-post.pre.js';
import { process } from './create-blog-post.process.js';
import { post } from './create-blog-post.post.js';
...
describe('BlogPost — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a BlogPost in the database', async () => {
...
describe('BlogPost — CREATE controller integration tests', () => {
   ...
   */
  it('POST /blog-posts responds with expected status', async () => {
    const res = await testApp.request('/blog-posts', {
      method: 'POST',
