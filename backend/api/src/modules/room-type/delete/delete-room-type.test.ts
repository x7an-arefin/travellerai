...
import { pre } from './delete-room-type.pre.js';
import { process } from './delete-room-type.process.js';
import { post } from './delete-room-type.post.js';
...
describe('RoomType — DELETE lifecycle unit tests', () => {
...
describe('RoomType — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /room-types/:id responds with expected status', async () => {
