...
import { pre } from './update-room-type.pre.js';
import { process } from './update-room-type.process.js';
import { post } from './update-room-type.post.js';
...
describe('RoomType — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a RoomType in the database', async () => {
...
describe('RoomType — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /room-types/:id responds with expected status', async () => {
