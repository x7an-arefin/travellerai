...
import { pre } from './list-room-type.pre.js';
import { process } from './list-room-type.process.js';
import { post } from './list-room-type.post.js';
...
describe('RoomType — LIST lifecycle unit tests', () => {
...
describe('RoomType — LIST controller integration tests', () => {
   ...
   */
  it('GET /room-types responds with expected status', async () => {
