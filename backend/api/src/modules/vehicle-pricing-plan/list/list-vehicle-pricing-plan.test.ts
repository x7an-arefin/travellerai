...
import { pre } from './list-vehicle-pricing-plan.pre.js';
import { process } from './list-vehicle-pricing-plan.process.js';
import { post } from './list-vehicle-pricing-plan.post.js';
...
describe('VehiclePricingPlan — LIST lifecycle unit tests', () => {
...
describe('VehiclePricingPlan — LIST controller integration tests', () => {
   ...
   */
  it('GET /vehicle-pricing-plans responds with expected status', async () => {
