...
import { pre } from './get-vehicle-pricing-plan.pre.js';
import { process } from './get-vehicle-pricing-plan.process.js';
import { post } from './get-vehicle-pricing-plan.post.js';
...
describe('VehiclePricingPlan — GET lifecycle unit tests', () => {
...
describe('VehiclePricingPlan — GET controller integration tests', () => {
   ...
   */
  it('GET /vehicle-pricing-plans/:id responds with expected status', async () => {
