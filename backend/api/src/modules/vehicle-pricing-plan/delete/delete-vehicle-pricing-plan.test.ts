...
import { pre } from './delete-vehicle-pricing-plan.pre.js';
import { process } from './delete-vehicle-pricing-plan.process.js';
import { post } from './delete-vehicle-pricing-plan.post.js';
...
describe('VehiclePricingPlan — DELETE lifecycle unit tests', () => {
...
describe('VehiclePricingPlan — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /vehicle-pricing-plans/:id responds with expected status', async () => {
