...
export const UpdateVehiclePricingPlanOutputSchema = VehiclePricingPlanBaseSchema;


export type UpdateVehiclePricingPlanOutput = z.infer<typeof UpdateVehiclePricingPlanOutputSchema>;
