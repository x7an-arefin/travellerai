...
import { pre } from './create-vehicle-pricing-plan.pre.js';
import { process } from './create-vehicle-pricing-plan.process.js';
import { post } from './create-vehicle-pricing-plan.post.js';
...
describe('VehiclePricingPlan — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a VehiclePricingPlan in the database', async () => {
...
describe('VehiclePricingPlan — CREATE controller integration tests', () => {
   ...
   */
  it('POST /vehicle-pricing-plans responds with expected status', async () => {
    const res = await testApp.request('/vehicle-pricing-plans', {
      method: 'POST',
