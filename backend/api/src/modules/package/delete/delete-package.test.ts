...
import { pre } from './delete-package.pre.js';
import { process } from './delete-package.process.js';
import { post } from './delete-package.post.js';
...
describe('Package — DELETE lifecycle unit tests', () => {
...
describe('Package — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /packages/:id responds with expected status', async () => {
