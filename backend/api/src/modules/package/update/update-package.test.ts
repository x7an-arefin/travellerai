...
import { pre } from './update-package.pre.js';
import { process } from './update-package.process.js';
import { post } from './update-package.post.js';
...
describe('Package — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a Package in the database', async () => {
...
describe('Package — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /packages/:id responds with expected status', async () => {
    const res = await testApp.request('/packages/:id', {
      method: 'PATCH',
