...
import { pre } from './get-package.pre.js';
import { process } from './get-package.process.js';
import { post } from './get-package.post.js';
...
describe('Package — GET lifecycle unit tests', () => {
...
describe('Package — GET controller integration tests', () => {
   ...
   */
  it('GET /packages/:id responds with expected status', async () => {
