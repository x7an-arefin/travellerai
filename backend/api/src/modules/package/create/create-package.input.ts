...
export const CreatePackageInputSchema = z.object({
  ...
  difficultyLevel: z.enum(['easy', 'moderate', 'challenging', 'extreme']).optional().default('easy'),
  confirmationType: z.enum(['instant', 'request_to_book']).optional().default('instant'),
  cancellationPolicy: z.enum(['flexible', 'moderate', 'strict', 'non_refundable']).optional().default('moderate'),
  ...
  status: z.enum(['draft', 'submitted', 'approved', 'published', 'unpublished', 'rejected', 'archived', 'suspended', 'expired']).optional().default('draft'),
