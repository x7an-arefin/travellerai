...
import { pre } from './delete-hotel-upsell-offer.pre.js';
import { process } from './delete-hotel-upsell-offer.process.js';
import { post } from './delete-hotel-upsell-offer.post.js';
...
describe('HotelUpsellOffer — DELETE lifecycle unit tests', () => {
...
describe('HotelUpsellOffer — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /hotel-upsell-offers/:id responds with expected status', async () => {
