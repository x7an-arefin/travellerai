...
import { HotelUpsellOfferController } from '@modules/hotel-upsell-offer/hotel-upsell-offer.controller.js';
import { HotelUpsellOfferService } from '@modules/hotel-upsell-offer/hotel-upsell-offer.service.js';
import { HotelUpsellOfferRepository } from '@modules/hotel-upsell-offer/hotel-upsell-offer.repository.js';
import { pre } from './update-hotel-upsell-offer.pre.js';
import { process } from './update-hotel-upsell-offer.process.js';
import { post } from './update-hotel-upsell-offer.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/hotel-upsell-offers'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('HotelUpsellOffer — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a HotelUpsellOffer in the database', async () => {
...
describe('HotelUpsellOffer — UPDATE controller integration tests', () => {
  ...
  beforeEach(async () => {
    testApp = await createControllerTestApplication({
      controller: HotelUpsellOfferController,
   ...
   */
  it('PATCH /hotel-upsell-offers/:id responds with expected status', async () => {
    const res = await testApp.request('/hotel-upsell-offers/:id', {
      method: 'PATCH',
