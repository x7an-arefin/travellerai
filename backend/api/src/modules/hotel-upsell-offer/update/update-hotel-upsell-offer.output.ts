...
export const UpdateHotelUpsellOfferOutputSchema = HotelUpsellOfferBaseSchema;


export type UpdateHotelUpsellOfferOutput = z.infer<typeof UpdateHotelUpsellOfferOutputSchema>;
