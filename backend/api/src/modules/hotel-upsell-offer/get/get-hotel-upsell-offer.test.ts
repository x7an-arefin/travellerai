...
import { pre } from './get-hotel-upsell-offer.pre.js';
import { process } from './get-hotel-upsell-offer.process.js';
import { post } from './get-hotel-upsell-offer.post.js';
...
describe('HotelUpsellOffer — GET lifecycle unit tests', () => {
...
describe('HotelUpsellOffer — GET controller integration tests', () => {
   ...
   */
  it('GET /hotel-upsell-offers/:id responds with expected status', async () => {
