...
import { pre } from './create-hotel-upsell-offer.pre.js';
import { process } from './create-hotel-upsell-offer.process.js';
import { post } from './create-hotel-upsell-offer.post.js';
...
describe('HotelUpsellOffer — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a HotelUpsellOffer in the database', async () => {
...
describe('HotelUpsellOffer — CREATE controller integration tests', () => {
   ...
   */
  it('POST /hotel-upsell-offers responds with expected status', async () => {
    const res = await testApp.request('/hotel-upsell-offers', {
      method: 'POST',
