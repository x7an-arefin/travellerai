...
import { pre } from './list-hotel-upsell-offer.pre.js';
import { process } from './list-hotel-upsell-offer.process.js';
import { post } from './list-hotel-upsell-offer.post.js';
...
describe('HotelUpsellOffer — LIST lifecycle unit tests', () => {
...
describe('HotelUpsellOffer — LIST controller integration tests', () => {
   ...
   */
  it('GET /hotel-upsell-offers responds with expected status', async () => {
