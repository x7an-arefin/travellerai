...
import { pre } from './get-package-addon.pre.js';
import { process } from './get-package-addon.process.js';
import { post } from './get-package-addon.post.js';
...
describe('PackageAddon — GET lifecycle unit tests', () => {
...
describe('PackageAddon — GET controller integration tests', () => {
   ...
   */
  it('GET /package-addons/:id responds with expected status', async () => {
