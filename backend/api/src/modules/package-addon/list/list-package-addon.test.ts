...
import { pre } from './list-package-addon.pre.js';
import { process } from './list-package-addon.process.js';
import { post } from './list-package-addon.post.js';
...
describe('PackageAddon — LIST lifecycle unit tests', () => {
...
describe('PackageAddon — LIST controller integration tests', () => {
   ...
   */
  it('GET /package-addons responds with expected status', async () => {
