...
import { pre } from './delete-package-addon.pre.js';
import { process } from './delete-package-addon.process.js';
import { post } from './delete-package-addon.post.js';
...
describe('PackageAddon — DELETE lifecycle unit tests', () => {
...
describe('PackageAddon — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /package-addons/:id responds with expected status', async () => {
