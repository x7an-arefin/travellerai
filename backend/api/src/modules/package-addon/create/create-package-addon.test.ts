...
import { pre } from './create-package-addon.pre.js';
import { process } from './create-package-addon.process.js';
import { post } from './create-package-addon.post.js';
...
describe('PackageAddon — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a PackageAddon in the database', async () => {
...
describe('PackageAddon — CREATE controller integration tests', () => {
   ...
   */
  it('POST /package-addons responds with expected status', async () => {
    const res = await testApp.request('/package-addons', {
      method: 'POST',
