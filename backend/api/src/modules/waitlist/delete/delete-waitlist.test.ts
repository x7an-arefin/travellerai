...
import { pre } from './delete-waitlist.pre.js';
import { process } from './delete-waitlist.process.js';
import { post } from './delete-waitlist.post.js';
...
describe('Waitlist — DELETE lifecycle unit tests', () => {
...
describe('Waitlist — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /waitlists/:id responds with expected status', async () => {
