...
import { pre } from './get-waitlist.pre.js';
import { process } from './get-waitlist.process.js';
import { post } from './get-waitlist.post.js';
...
describe('Waitlist — GET lifecycle unit tests', () => {
...
describe('Waitlist — GET controller integration tests', () => {
   ...
   */
  it('GET /waitlists/:id responds with expected status', async () => {
