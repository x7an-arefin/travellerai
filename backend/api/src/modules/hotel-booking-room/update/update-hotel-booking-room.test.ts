...
import { pre } from './update-hotel-booking-room.pre.js';
import { process } from './update-hotel-booking-room.process.js';
import { post } from './update-hotel-booking-room.post.js';
...
describe('HotelBookingRoom — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a HotelBookingRoom in the database', async () => {
...
describe('HotelBookingRoom — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /hotel-booking-rooms/:id responds with expected status', async () => {
