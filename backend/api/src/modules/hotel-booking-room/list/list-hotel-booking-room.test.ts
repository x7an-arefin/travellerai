...
import { pre } from './list-hotel-booking-room.pre.js';
import { process } from './list-hotel-booking-room.process.js';
import { post } from './list-hotel-booking-room.post.js';
...
describe('HotelBookingRoom — LIST lifecycle unit tests', () => {
...
describe('HotelBookingRoom — LIST controller integration tests', () => {
   ...
   */
  it('GET /hotel-booking-rooms responds with expected status', async () => {
