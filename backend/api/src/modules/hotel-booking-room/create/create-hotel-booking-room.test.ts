...
import { pre } from './create-hotel-booking-room.pre.js';
import { process } from './create-hotel-booking-room.process.js';
import { post } from './create-hotel-booking-room.post.js';
...
describe('HotelBookingRoom — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a HotelBookingRoom in the database', async () => {
...
describe('HotelBookingRoom — CREATE controller integration tests', () => {
   ...
   */
  it('POST /hotel-booking-rooms responds with expected status', async () => {
    const res = await testApp.request('/hotel-booking-rooms', {
      method: 'POST',
