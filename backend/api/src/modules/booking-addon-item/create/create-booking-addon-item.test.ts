...
import { pre } from './create-booking-addon-item.pre.js';
import { process } from './create-booking-addon-item.process.js';
import { post } from './create-booking-addon-item.post.js';
...
describe('BookingAddonItem — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a BookingAddonItem in the database', async () => {
...
describe('BookingAddonItem — CREATE controller integration tests', () => {
   ...
   */
  it('POST /booking-addon-items responds with expected status', async () => {
    const res = await testApp.request('/booking-addon-items', {
      method: 'POST',
