...
import { pre } from './list-booking-addon-item.pre.js';
import { process } from './list-booking-addon-item.process.js';
import { post } from './list-booking-addon-item.post.js';
...
describe('BookingAddonItem — LIST lifecycle unit tests', () => {
...
describe('BookingAddonItem — LIST controller integration tests', () => {
   ...
   */
  it('GET /booking-addon-items responds with expected status', async () => {
