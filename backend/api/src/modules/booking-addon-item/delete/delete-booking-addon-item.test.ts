...
import { pre } from './delete-booking-addon-item.pre.js';
import { process } from './delete-booking-addon-item.process.js';
import { post } from './delete-booking-addon-item.post.js';
...
describe('BookingAddonItem — DELETE lifecycle unit tests', () => {
...
describe('BookingAddonItem — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /booking-addon-items/:id responds with expected status', async () => {
