...
import { pre } from './get-booking-addon-item.pre.js';
import { process } from './get-booking-addon-item.process.js';
import { post } from './get-booking-addon-item.post.js';
...
describe('BookingAddonItem — GET lifecycle unit tests', () => {
...
describe('BookingAddonItem — GET controller integration tests', () => {
   ...
   */
  it('GET /booking-addon-items/:id responds with expected status', async () => {
