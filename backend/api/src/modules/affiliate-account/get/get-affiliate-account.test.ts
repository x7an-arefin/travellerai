...
import { pre } from './get-affiliate-account.pre.js';
import { process } from './get-affiliate-account.process.js';
import { post } from './get-affiliate-account.post.js';
...
describe('AffiliateAccount — GET lifecycle unit tests', () => {
...
describe('AffiliateAccount — GET controller integration tests', () => {
   ...
   */
  it('GET /affiliate-accounts/:id responds with expected status', async () => {
