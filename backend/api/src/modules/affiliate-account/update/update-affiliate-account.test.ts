...
import { AffiliateAccountController } from '@modules/affiliate-account/affiliate-account.controller.js';
import { AffiliateAccountService } from '@modules/affiliate-account/affiliate-account.service.js';
import { AffiliateAccountRepository } from '@modules/affiliate-account/affiliate-account.repository.js';
import { pre } from './update-affiliate-account.pre.js';
import { process } from './update-affiliate-account.process.js';
import { post } from './update-affiliate-account.post.js';
...
function makeCtx(overrides: Partial<LifecycleContext> = {}): LifecycleContext {
  return {
    ...
    request: new Request('https://example.com/affiliate-accounts'),
    input: {},
    result: null,
    meta: {},
    ...overrides,
...
describe('AffiliateAccount — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a AffiliateAccount in the database', async () => {
...
describe('AffiliateAccount — UPDATE controller integration tests', () => {
  ...
  beforeEach(async () => {
    testApp = await createControllerTestApplication({
      controller: AffiliateAccountController,
   ...
   */
  it('PATCH /affiliate-accounts/:id responds with expected status', async () => {
    const res = await testApp.request('/affiliate-accounts/:id', {
      method: 'PATCH',
