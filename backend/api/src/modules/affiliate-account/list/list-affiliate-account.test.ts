...
import { pre } from './list-affiliate-account.pre.js';
import { process } from './list-affiliate-account.process.js';
import { post } from './list-affiliate-account.post.js';
...
describe('AffiliateAccount — LIST lifecycle unit tests', () => {
...
describe('AffiliateAccount — LIST controller integration tests', () => {
   ...
   */
  it('GET /affiliate-accounts responds with expected status', async () => {
