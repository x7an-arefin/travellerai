...
import { pre } from './create-affiliate-account.pre.js';
import { process } from './create-affiliate-account.process.js';
import { post } from './create-affiliate-account.post.js';
...
describe('AffiliateAccount — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a AffiliateAccount in the database', async () => {
...
describe('AffiliateAccount — CREATE controller integration tests', () => {
   ...
   */
  it('POST /affiliate-accounts responds with expected status', async () => {
    const res = await testApp.request('/affiliate-accounts', {
      method: 'POST',
