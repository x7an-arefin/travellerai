...
import { pre } from './delete-affiliate-account.pre.js';
import { process } from './delete-affiliate-account.process.js';
import { post } from './delete-affiliate-account.post.js';
...
describe('AffiliateAccount — DELETE lifecycle unit tests', () => {
...
describe('AffiliateAccount — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /affiliate-accounts/:id responds with expected status', async () => {
