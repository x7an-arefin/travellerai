...
import { pre } from './delete-exchange-rate.pre.js';
import { process } from './delete-exchange-rate.process.js';
import { post } from './delete-exchange-rate.post.js';
...
describe('ExchangeRate — DELETE lifecycle unit tests', () => {
...
describe('ExchangeRate — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /exchange-rates/:id responds with expected status', async () => {
