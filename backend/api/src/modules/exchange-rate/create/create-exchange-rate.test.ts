...
import { pre } from './create-exchange-rate.pre.js';
import { process } from './create-exchange-rate.process.js';
import { post } from './create-exchange-rate.post.js';
...
describe('ExchangeRate — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a ExchangeRate in the database', async () => {
...
describe('ExchangeRate — CREATE controller integration tests', () => {
   ...
   */
  it('POST /exchange-rates responds with expected status', async () => {
