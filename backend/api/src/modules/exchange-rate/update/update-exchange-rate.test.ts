...
import { pre } from './update-exchange-rate.pre.js';
import { process } from './update-exchange-rate.process.js';
import { post } from './update-exchange-rate.post.js';
...
describe('ExchangeRate — UPDATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully update a ExchangeRate in the database', async () => {
...
describe('ExchangeRate — UPDATE controller integration tests', () => {
   ...
   */
  it('PATCH /exchange-rates/:id responds with expected status', async () => {
