...
import { pre } from './list-inventory-calendar.pre.js';
import { process } from './list-inventory-calendar.process.js';
import { post } from './list-inventory-calendar.post.js';
...
describe('InventoryCalendar — LIST lifecycle unit tests', () => {
...
describe('InventoryCalendar — LIST controller integration tests', () => {
   ...
   */
  it('GET /inventory-calendars responds with expected status', async () => {
