...
import { pre } from './create-inventory-calendar.pre.js';
import { process } from './create-inventory-calendar.process.js';
import { post } from './create-inventory-calendar.post.js';
...
describe('InventoryCalendar — CREATE lifecycle unit tests', () => {
  ...
  describe('process()', () => {
     ...
     */
    it('should successfully create a InventoryCalendar in the database', async () => {
...
describe('InventoryCalendar — CREATE controller integration tests', () => {
   ...
   */
  it('POST /inventory-calendars responds with expected status', async () => {
    const res = await testApp.request('/inventory-calendars', {
      method: 'POST',
