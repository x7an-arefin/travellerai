...
import { pre } from './delete-inventory-calendar.pre.js';
import { process } from './delete-inventory-calendar.process.js';
import { post } from './delete-inventory-calendar.post.js';
...
describe('InventoryCalendar — DELETE lifecycle unit tests', () => {
...
describe('InventoryCalendar — DELETE controller integration tests', () => {
   ...
   */
  it('DELETE /inventory-calendars/:id responds with expected status', async () => {
